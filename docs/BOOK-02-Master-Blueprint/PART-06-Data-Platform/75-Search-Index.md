...
The **Search Index** capability is responsible for:
...
The **Search Index** capability should be treated as a shared platform capability.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> DataCapability[Search Index]
...
The **Search Index** design should consider:
...
The **Search Index** capability must enforce:
...
The **Search Index** capability may handle personal, customer, organizational, or sensitive operational data.
...
The **Search Index** capability should expose:
...
The **Search Index** capability may evolve with:
