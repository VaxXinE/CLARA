...
The **Data Ownership** capability is responsible for:
...
The **Data Ownership** capability should be treated as a shared platform capability.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> DataCapability[Data Ownership]
...
The **Data Ownership** design should consider:
...
The **Data Ownership** capability must enforce:
...
The **Data Ownership** capability may handle personal, customer, organizational, or sensitive operational data.
...
The **Data Ownership** capability should expose:
...
The **Data Ownership** capability may evolve with:
