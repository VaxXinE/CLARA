...
The **Data Lifecycle** capability is responsible for:
...
The **Data Lifecycle** capability should be treated as a shared platform capability.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> DataCapability[Data Lifecycle]
...
The **Data Lifecycle** design should consider:
...
The **Data Lifecycle** capability must enforce:
...
The **Data Lifecycle** capability may handle personal, customer, organizational, or sensitive operational data.
...
The **Data Lifecycle** capability should expose:
...
The **Data Lifecycle** capability may evolve with:
