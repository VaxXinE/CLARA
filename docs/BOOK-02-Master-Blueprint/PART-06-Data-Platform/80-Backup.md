...
The **Backup** capability is responsible for:
...
The **Backup** capability should be treated as a shared platform capability.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> DataCapability[Backup]
...
The **Backup** capability must enforce:
...
The **Backup** capability may handle personal, customer, organizational, or sensitive operational data.
...
The **Backup** capability should expose:
...
The **Backup** capability may evolve with:
