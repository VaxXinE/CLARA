...
next: "../PART-07-Security-Platform/82-Security-Overview.md"
---
...
The **Disaster Recovery** capability is responsible for:
...
The **Disaster Recovery** capability should be treated as a shared platform capability.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> DataCapability[Disaster Recovery]
...
The **Disaster Recovery** design should consider:
...
The **Disaster Recovery** capability must enforce:
...
The **Disaster Recovery** capability may handle personal, customer, organizational, or sensitive operational data.
...
The **Disaster Recovery** capability should expose:
...
The **Disaster Recovery** capability may evolve with:
