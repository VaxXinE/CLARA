...
The **Reporting** service provides a reusable capability that should be consumed by business domains, AI components, integration capabilities, workflows, and operational tools through stable contracts.
...
The **Reporting** service should act as a platform primitive.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> Service[Reporting]
...
The **Reporting** service must enforce:
...
The **Reporting** service should expose:
...
The **Reporting** service may evolve with:
