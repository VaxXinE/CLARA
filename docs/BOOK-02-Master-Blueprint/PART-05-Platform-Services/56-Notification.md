...
The **Notification** service provides a reusable capability that should be consumed by business domains, AI components, integration capabilities, workflows, and operational tools through stable contracts.
...
The **Notification** service should act as a platform primitive.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> Service[Notification]
...
The **Notification** service must enforce:
...
The **Notification** service may evolve with:
