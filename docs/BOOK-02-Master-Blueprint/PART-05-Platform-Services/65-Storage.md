...
The **Storage** service provides a reusable capability that should be consumed by business domains, AI components, integration capabilities, workflows, and operational tools through stable contracts.
...
The **Storage** service should act as a platform primitive.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> Service[Storage]
...
The **Storage** service must enforce:
...
The **Storage** service may evolve with:
