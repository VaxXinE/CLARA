...
The **Audit** service provides a reusable capability that should be consumed by business domains, AI components, integration capabilities, workflows, and operational tools through stable contracts.
...
The **Audit** service should act as a platform primitive.
...
```mermaid
flowchart LR
    Domain[Business Domain] --> Service[Audit]
...
The **Audit** service must enforce:
...
The **Audit** service should expose:
...
The **Audit** service may evolve with:
