...
previous: "./52-Tool-Calling.md"
next: "./54-AI-Governance.md"
---

# AI Workflow

> *"Defines how AI participates in structured business workflows."*
...
This chapter explains the blueprint-level role of **AI Workflow** inside Athena's AI Platform.

---

# Overview

The **AI Workflow** is part of Athena's governed AI architecture.
...
```mermaid
flowchart LR
    Input[Input] --> Component[AI Workflow]
...
The **AI Workflow** should be treated as a platform capability.
...
The **AI Workflow** should support governance through:
