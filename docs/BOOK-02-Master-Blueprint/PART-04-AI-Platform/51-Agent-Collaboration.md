...
This chapter explains the blueprint-level role of **Agent Collaboration** inside Clara's AI Platform.

---

# Overview

The **Agent Collaboration** is part of Clara's governed AI architecture.
