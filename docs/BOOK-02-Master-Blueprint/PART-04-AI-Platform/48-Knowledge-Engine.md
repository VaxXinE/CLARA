...
This chapter explains the blueprint-level role of **Knowledge Engine** inside Athena's AI Platform.

---

# Overview

The **Knowledge Engine** is part of Athena's governed AI architecture.
