...
This chapter explains the blueprint-level role of **Context Engine** inside Athena's AI Platform.

---

# Overview

The **Context Engine** is part of Athena's governed AI architecture.
