...
This chapter explains the blueprint-level role of **Prompt Engine** inside Athena's AI Platform.

---

# Overview

The **Prompt Engine** is part of Athena's governed AI architecture.
