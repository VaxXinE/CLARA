...
> *"Defines Kubernetes as an orchestration foundation for running Clara workloads at scale."*
...
This chapter defines the blueprint-level role of **Kubernetes** inside Clara's Infrastructure layer.

---

# Overview

The **Kubernetes** capability supports Clara's ability to run services reliably, securely, and consistently across environments.
