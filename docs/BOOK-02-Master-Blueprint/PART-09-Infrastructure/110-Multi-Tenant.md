...
next: "../PART-10-Roadmap/111-Roadmap-Overview.md"
---
...
The **Multi Tenant** capability is responsible for:
...
The **Multi Tenant** design should consider:
...
The **Multi Tenant** capability must support:
...
The **Multi Tenant** capability should support visibility into:
...
The **Multi Tenant** capability may evolve with:
