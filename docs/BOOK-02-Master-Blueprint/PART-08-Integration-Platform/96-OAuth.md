...
> *"Defines delegated authorization for connecting Clara with external platforms safely."*
...
This chapter defines the blueprint-level role of **OAuth** inside Clara's Integration Platform.

---

# Overview

The **OAuth** capability allows Clara to connect with external systems, internal services, client applications, plugins, extensions, and developer tools through governed integration contracts.
...
The **OAuth** capability should be treated as part of Clara's shared Integration Platform.
