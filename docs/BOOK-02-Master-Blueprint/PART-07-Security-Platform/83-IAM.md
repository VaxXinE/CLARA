...
> *"Defines Identity and Access Management as the foundation for authenticated and authorized access across Clara."*
...
This chapter defines the blueprint-level responsibility of **IAM** inside Clara's Security Platform.

---

# Overview

The **IAM** capability is part of Clara's shared Security Platform.
