...
previous: "./82-Security-Overview.md"
next: "./84-Zero-Trust.md"
---

# IAM

> *"Defines Identity and Access Management as the foundation for authenticated and authorized access across Athena."*
...
This chapter defines the blueprint-level responsibility of **IAM** inside Athena's Security Platform.

---

# Overview

The **IAM** capability is part of Athena's shared Security Platform.
...
The **IAM** capability is responsible for:
...
The **IAM** capability should be treated as a shared security foundation.
...
```mermaid
flowchart LR
    Actor[User / Service / AI / Plugin] --> Security[IAM]
...
The **IAM** design should consider:
...
The **IAM** capability should ensure AI does not:
...
The **IAM** capability should help enforce:
...
The **IAM** capability should expose:
...
The **IAM** capability may evolve with:
