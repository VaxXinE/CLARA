...
The **Zero Trust** capability should be treated as a shared security foundation.
...
```mermaid
flowchart LR
    Actor[User / Service / AI / Plugin] --> Security[Zero Trust]
...
The **Zero Trust** design should consider:
...
The **Zero Trust** capability should ensure AI does not:
...
The **Zero Trust** capability should help enforce:
...
The **Zero Trust** capability should expose:
...
The **Zero Trust** capability may evolve with:
