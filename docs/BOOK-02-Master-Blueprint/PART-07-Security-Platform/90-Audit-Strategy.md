...
The **Audit Strategy** capability should be treated as a shared security foundation.
...
```mermaid
flowchart LR
    Actor[User / Service / AI / Plugin] --> Security[Audit Strategy]
...
The **Audit Strategy** design should consider:
...
The **Audit Strategy** capability should ensure AI does not:
...
The **Audit Strategy** capability should help enforce:
...
The **Audit Strategy** capability should expose:
...
The **Audit Strategy** capability may evolve with:
