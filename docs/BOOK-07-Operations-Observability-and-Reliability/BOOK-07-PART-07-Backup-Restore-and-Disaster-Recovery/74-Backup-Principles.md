...
previous: "73-Backup-Restore-and-Disaster-Recovery-Overview.md"
next: "75-Data-Protection-and-Recovery-Scope.md"
project: "CLARA"
---

# Backup Principles

> *"Defines CLARA's backup principles across databases, files, configurations, secrets references, infrastructure definitions, and operational evidence."*
...
Backups can create false confidence or security risk when they are untested, unencrypted, or poorly governed.
...
CLARA backup strategy should prioritize recoverability, integrity, security, encryption, access control, restore testing, and evidence.
...
CLARA backup and recovery should follow:

```text
restore-tested, not backup-assumed
encrypted by default
least privilege access
separate storage/isolation where practical
...
|---|---|
| Restore-tested | Periodic restore exercises |
| Encrypted | Backup data protected at rest/in transit |
| Least privilege | Only approved operators access backup |
| Retention by class | Different data may need different retention |
| Validation | Restore must prove data and workflows work |
| Evidence | Tests and recoveries are documented |

---

# Security Rule

Backups are sensitive production data.
