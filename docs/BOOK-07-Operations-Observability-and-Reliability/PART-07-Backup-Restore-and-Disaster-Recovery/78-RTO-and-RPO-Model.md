...
chapter: "78"
title: "RTO and RPO Model"
version: "1.0.0"
status: "official"
owner: "CLARA Operations Team"
last_updated: "2026-07-07"
classification: "backup-restore-disaster-recovery"
previous: "77-Restore-Testing-and-Validation.md"
next: "79-Database-Backup-and-Restore.md"
project: "CLARA"
---

# RTO and RPO Model

> *"Defines Recovery Time Objective and Recovery Point Objective expectations for CLARA services and data classes."*
...
Teams cannot make good recovery decisions without knowing how much downtime and data loss is acceptable.
...
CLARA should define practical RTO and RPO targets for critical workflows, databases, files, integrations, and operational systems.
...
How long the service/workflow can be unavailable.
...
| Class | Example | Initial Target |
|---|---|---|
| Critical | auth, inbox, conversations, tickets | lowest practical RTO/RPO |
| High | integrations, AI Gateway, files | low to moderate RTO/RPO |
| Medium | analytics/reporting | moderate RTO/RPO |
| Low | non-critical derived views | longer RTO/RPO acceptable |

---

# RTO/RPO Rule

Do not promise aggressive RTO/RPO until restore tests prove they are realistic.
