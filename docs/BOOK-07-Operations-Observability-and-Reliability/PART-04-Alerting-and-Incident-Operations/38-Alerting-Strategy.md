...
previous: "37-Alerting-and-Incident-Operations-Overview.md"
next: "39-Alert-Severity-and-Priority-Model.md"
project: "CLARA"
---

# Alerting Strategy

> *"Defines how CLARA decides what should alert, what should be dashboard-only, what should be ticketed, and what should be reviewed periodically."*
...
Too many low-quality alerts cause alert fatigue and make teams miss the important ones.
...
CLARA alerting should focus on actionable, user-impacting, owned signals rather than every possible technical anomaly.
...
CLARA should use four signal classes:

| Signal Class | Meaning | Example |
|---|---|---|
| Page/Immediate Alert | Needs urgent human action | total outage, auth failure spike |
| Ticket/Task | Needs action but not immediate page | recurring warning, capacity trend |
| Dashboard Review | Useful during regular review | latency trend, queue growth |
| Log Only | Useful for investigation | normal lifecycle events |
...
provider outage with user impact
queue backlog threatening SLA
database unavailable
failed deployment causing impact
AI feature unsafe behavior
```
...
Alert on symptoms users feel, then use dashboards/logs to find causes.
