...
previous: "43-AB-and-Cohort-Analysis.md"
next: "45-Growth-Risk-Management.md"
project: "CLARA"
---

# Growth Experiment Review

> *"Defines experiment review workflow, outcome interpretation, success/failure/neutral decisions, learning capture, and follow-up actions."*
...
Experiments lose value when results are not reviewed and converted into learning.
...
CLARA growth experiments should be reviewed with evidence, guardrail outcomes, customer impact, and a clear continue/iterate/stop decision.
...
```text
ship broadly
ship to segment only
iterate and rerun
stop and rollback
convert to roadmap item
convert to documentation/support update
needs more data
```
...
Every experiment must end with a decision, not just a dashboard.
