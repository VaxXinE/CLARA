...
chapter: "63"
title: "Metric Definitions and Governance"
version: "1.0.0"
status: "official"
owner: "CLARA Analytics and Product Operations Team"
last_updated: "2026-07-07"
classification: "analytics-product-insights"
previous: "62-Product-Event-Taxonomy.md"
next: "64-Dashboard-Strategy.md"
project: "CLARA"
---

# Metric Definitions and Governance

> *"Defines metric ownership, metric dictionary, calculation rules, source of truth, review cadence, versioning, and quality checks."*
...
Metrics create conflict when different teams calculate the same concept differently.
...
CLARA metrics should have clear definitions, owners, data sources, calculation logic, guardrails, and review cadence.
...
If two dashboards calculate the same metric differently, one must be deprecated or renamed.
