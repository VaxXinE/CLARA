...
previous: "63-Metric-Definitions-and-Governance.md"
next: "65-Funnel-and-Retention-Analysis.md"
project: "CLARA"
---

# Dashboard Strategy

> *"Defines dashboard types, dashboard ownership, audience, refresh cadence, health indicators, drill-downs, and dashboard hygiene."*
...
Dashboards become noise when they show charts without decisions or owners.
...
CLARA dashboards should answer specific operating questions for product, support, success, engineering, security, leadership, and revenue teams.
...
A dashboard should answer an operating question, not just display data.
