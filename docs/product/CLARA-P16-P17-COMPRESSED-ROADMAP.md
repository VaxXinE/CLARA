...
billing/payment is deferred. P17-PR-01 prepares AI provider runtime configuration but does not yet execute extension snapshot AI analysis.
...
- P17-PR-01 AI Provider Runtime Config + Secret Boundary + Cost Guardrail (current).
