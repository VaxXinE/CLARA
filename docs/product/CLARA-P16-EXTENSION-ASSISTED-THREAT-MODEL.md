# CLARA P16 Extension-Assisted Threat Model
...
- Over-capture of browser data beyond active chat.
- Cross-workspace attribution from client-supplied workspaceId.
- Silent background capture without operator awareness.
- Mistaking extension-assisted ingestion for official provider API access.
