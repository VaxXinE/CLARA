# CLARA P18 Final Known Limitations Review
...
| limitation_id | safe_summary | severity | disposition |
| --- | --- | --- | --- |
| `p18-limitation-placeholder` | placeholder only | medium | review before next phase |
