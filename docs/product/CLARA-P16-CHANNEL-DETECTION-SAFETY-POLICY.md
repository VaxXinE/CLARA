# CLARA P16 Channel Detection Safety Policy
...
Channel detection recognizes only supported active-chat contexts:

- WhatsApp Web at `web.whatsapp.com`.
- Instagram direct-message pages under `/direct`.
- TikTok message pages under `/messages`.

Unsupported hosts and unsupported contexts fail closed. Detection does not
activate official provider APIs, crawl inboxes, or authorize workspace access.
