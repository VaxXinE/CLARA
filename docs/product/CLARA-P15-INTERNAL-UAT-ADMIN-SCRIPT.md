# CLARA P15 Internal UAT Admin Script
...
- Confirm admin/owner can view safe readiness and member metadata where allowed.
- Confirm no invite, role update, delete, billing, provider activation, or
  production deploy controls appear.
- Confirm workspace scope is derived from backend AuthContext.
- Confirm issue capture remains manual/local/repo-safe.
