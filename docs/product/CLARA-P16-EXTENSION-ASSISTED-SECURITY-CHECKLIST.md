# CLARA P16 Extension-Assisted Security Checklist
...
- Confirm active-chat-only capture.
- Confirm operator awareness/consent.
- Confirm no official provider API activation.
- Confirm no real AI provider call and no outbound auto-send.
