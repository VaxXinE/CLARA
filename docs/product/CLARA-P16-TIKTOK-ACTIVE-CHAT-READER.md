# CLARA P16 TikTok Active Chat Reader
...
The TikTok reader is limited to an operator-opened TikTok messages active chat.
It fails closed outside safe messages context or when no visible active chat is
available. It does not crawl inboxes, inspect hidden threads, read browser
storage, or activate official TikTok APIs.
