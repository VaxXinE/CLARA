# CLARA P18 Runtime Trial Evidence Index
...
| evidence_id | execution_id | source_doc | safe_summary | retention_disposal |
| --- | --- | --- | --- | --- |
| `p18-evidence-placeholder` | `p18-exec-placeholder` | evidence log | placeholder only | review before disposal |

Only redacted evidence ids and safe summaries belong here.
