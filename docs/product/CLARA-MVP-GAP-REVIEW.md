...
multi-channel registry and channel account read foundation now exposes safe Gmail capabilities, Webchat inbound foundation, plus planned WhatsApp, Instagram, and TikTok metadata
```
...
multi-channel support is registry/account/health metadata plus Webchat inbound only outside Gmail; WhatsApp, Instagram, and TikTok have no provider integration, webhook, send, or sync runtime yet
```
