...
multi-channel registry and channel account read foundation now exposes safe Gmail capabilities plus planned WhatsApp, Instagram, TikTok, and Webchat metadata
```
...
multi-channel support is registry/account/health metadata only outside Gmail; WhatsApp, Instagram, TikTok, and Webchat have no provider integration, webhook, send, or sync runtime yet
```
