...
multi-channel registry and channel account read foundation now exposes safe Gmail capabilities, Webchat inbound plus simulated human-triggered Webchat reply/status visibility, and planned WhatsApp, Instagram, and TikTok metadata
```
...
multi-channel support is registry/account/health metadata plus Webchat inbound and simulated Webchat reply/status visibility outside Gmail; WhatsApp, Instagram, and TikTok have no provider integration, webhook, send, or sync runtime yet
```
