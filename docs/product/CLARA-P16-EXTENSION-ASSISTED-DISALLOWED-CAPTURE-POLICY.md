# CLARA P16 Extension-Assisted Disallowed Capture Policy
...
- Cookies, session tokens, auth headers, API keys, and browser storage secrets.
- Raw DOM, raw HTML, full page dumps, hidden conversations, background inbox
  crawling, and mass scraping.
- Payment data, raw prompts, raw provider payloads, raw webhook payloads, and
