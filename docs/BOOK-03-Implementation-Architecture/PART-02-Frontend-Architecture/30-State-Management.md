...
next: "./31-Design-System.md"
---

# State Management

> *"Defines how frontend state is managed across pages, features, sessions, forms, and asynchronous data flows."*
...
final customerListControllerProvider =
    AsyncNotifierProvider<CustomerListController, List<CustomerDto>>(
  CustomerListController.new,
);

class CustomerListController extends AsyncNotifier<List<CustomerDto>> {
  @override
