...
This chapter defines how **API Client** should be implemented consistently across Clara client applications.
...
Clara frontend should use typed API clients and never call raw HTTP directly from UI widgets.
