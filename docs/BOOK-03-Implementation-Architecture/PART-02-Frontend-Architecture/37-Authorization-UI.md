...
next: "./38-Error-Handling.md"
---

# Authorization UI

> *"Defines permission-aware UI behavior without treating the UI as the final authorization boundary."*
...
class PermissionGate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final allowed = context.watch<PermissionController>().can(permission);
