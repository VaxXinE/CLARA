...
next: "./94-Plugin-SDK-Implementation.md"
---

# External Connector Architecture

> *"Defines external connector adapters, provider contracts, capability discovery, tenant configuration, and execution lifecycle."*
...
```ts
// integration/connectors/Connector.ts
export interface Connector {
  ...
  execute(action: string, payload: unknown): Promise<ConnectorResult>;
}
