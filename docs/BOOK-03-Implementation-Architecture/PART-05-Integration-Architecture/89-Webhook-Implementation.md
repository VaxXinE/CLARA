...
next: "./90-WebSocket-Realtime.md"
---

# Webhook Implementation

> *"Defines inbound and outbound webhook architecture, signature verification, idempotency, retry, delivery logs, and security."*
...
export async function inboundWebhookHandler(request: HttpRequest): Promise<HttpResponse> {
  ...
  await webhookSignatureVerifier.verify({
    ...
    secretRef: "webhook/provider/customer-support",
  });

  await webhookInbox.record({
