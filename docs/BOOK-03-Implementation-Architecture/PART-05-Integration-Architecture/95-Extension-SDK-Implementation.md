...
next: "./96-Marketplace-Integration.md"
---

# Extension SDK Implementation

> *"Defines browser/client extension SDK boundaries, message passing, permissions, content script safety, and backend integration."*
