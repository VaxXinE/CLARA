...
next: "./93-External-Connector-Architecture.md"
---

# API Gateway Integration

> *"Defines API gateway responsibilities including routing, authentication enforcement, rate limits, request metadata, and edge controls."*
...
```ts
// gateway/policies/requestContext.ts
export function buildRequestContext(request: GatewayRequest): RequestContext {
  return {
