...
next: "./98-Integration-Authentication.md"
---

# Third Party API Clients

> *"Defines third-party API client design, typed responses, retries, timeouts, error mapping, and provider isolation."*
...
```ts
// integration/providers/slack/SlackApiClient.ts
export class SlackApiClient {
  constructor(private readonly http: HttpClient) {}

  async postMessage(input: SlackPostMessageInput): Promise<void> {
    await this.http.post("/chat.postMessage", {
      timeoutMs: 5000,
