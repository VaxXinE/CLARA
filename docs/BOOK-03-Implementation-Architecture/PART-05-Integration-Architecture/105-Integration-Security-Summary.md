...
chapter: "105"
title: "Integration Security Summary"
version: "1.0.0"
status: "official"
owner: "Athena Architecture Team"
last_updated: "2026-07-07"
classification: "implementation-architecture"
previous: "./104-Integration-Observability.md"
next: "../PART-06-Infrastructure-Architecture/README.md"
---

# Integration Security Summary

> *"Summarizes integration security principles, common threats, control requirements, and production readiness criteria."*
...
This chapter defines how **Integration Security Summary** should be implemented safely and consistently.
...
Athena integrations should be secure by default through credential vaulting, least privilege, signature verification, tenant scoping, audit, and safe retries.
...
```ts
// Integration security rule of thumb:
//
// Verify inbound messages.
// Vault outbound credentials.
// Authorize every action.
// Scope every data request.
// Validate every payload.
// Redact every sensitive log.
// Audit every sensitive operation.
// Retry only when safe.
// Make every external call observable.
