...
chapter: "94"
title: "Plugin SDK Implementation"
version: "1.0.0"
status: "official"
owner: "Athena Architecture Team"
last_updated: "2026-07-07"
classification: "implementation-architecture"
previous: "./93-External-Connector-Architecture.md"
next: "./95-Extension-SDK-Implementation.md"
---

# Plugin SDK Implementation

> *"Defines plugin SDK architecture, extension points, manifest format, sandboxing, permissions, and lifecycle management."*
...
This chapter defines how **Plugin SDK Implementation** should be implemented safely and consistently.
...
Athena plugins should declare capabilities and permissions through a manifest and execute only through approved platform extension points.
...
```ts
// plugin/manifest/pluginManifestSchema.ts
export const pluginManifestSchema = z.object({
  ...
  entrypoints: z.array(z.object({
    type: z.enum(["action", "panel", "workflow_step"]),
    name: z.string(),
  })),
});
