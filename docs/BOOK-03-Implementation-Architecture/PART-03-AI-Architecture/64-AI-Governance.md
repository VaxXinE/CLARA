...
next: "./65-AI-Architecture-Summary.md"
---

# AI Governance

> *"Defines governance controls for model usage, auditability, policy compliance, data retention, and release management."*
...
```ts
// ai/governance/AiFeaturePolicy.ts
export class AiFeaturePolicy {
  constructor(
    ...
    public readonly piiAllowed: boolean,
  ) {}
}
