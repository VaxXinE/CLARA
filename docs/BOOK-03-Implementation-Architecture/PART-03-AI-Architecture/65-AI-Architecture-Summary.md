...
next: "../PART-04-Data-Architecture/README.md"
---
...
```ts
// AI architecture rule of thumb:
//
// Product modules request AI capability.
// AI Gateway controls model access.
// Context Builder controls knowledge exposure.
// Guardrails control safety.
// Tool Executor controls actions.
// Evaluation controls release quality.
// Governance controls production use.
