...
next: "./53-Memory-Architecture.md"
---

# Vector Retrieval

> *"Defines embedding generation, vector search, hybrid search, ranking, and retrieval safety boundaries."*
...
```ts
// knowledge/application/VectorRetriever.ts
  ...
  async search(input: VectorSearchInput): Promise<KnowledgeChunk[]> {
    return this.vectorStore.search({
      ...
      filters: {
        ...
        visibility: input.allowedVisibility,
      },
      limit: input.limit,
    });
  }
