...
previous: "./50-Context-Engineering.md"
next: "./52-Vector-Retrieval.md"
---

# RAG Pipeline

> *"Defines Retrieval-Augmented Generation pipeline, ingestion, chunking, retrieval, grounding, and answer generation."*
...
This chapter defines how **RAG Pipeline** should be implemented safely and consistently.
...
Athena should use RAG for knowledge-grounded AI answers instead of relying only on model memory.
...
```ts
// ai/application/rag/RagAnswerUseCase.ts
export class RagAnswerUseCase {
  constructor(
    private readonly retriever: KnowledgeRetriever,
    private readonly gateway: AiGateway,
  ) {}

  async execute(input: RagAnswerInput): Promise<RagAnswerOutput> {
