...
previous: "./62-Human-In-The-Loop.md"
next: "./64-AI-Governance.md"
---

# AI Security

> *"Defines security risks unique to AI systems, including prompt injection, data exfiltration, tool abuse, and model output risks."*
...
This chapter defines how **AI Security** should be implemented safely and consistently.
...
Athena AI systems should be secure-by-design with explicit defenses against prompt injection, unauthorized tool use, and sensitive data leakage.
...
```ts
// ai/security/PromptInjectionDetector.ts
export class PromptInjectionDetector {
  detect(input: string): PromptInjectionRisk {
    const riskyPatterns = [
    ...
    const matched = riskyPatterns.filter((pattern) =>
