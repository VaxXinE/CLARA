...
next: "./63-AI-Security.md"
---

# Human In The Loop

> *"Defines review, approval, override, escalation, and human confirmation for sensitive AI actions."*
...
```ts
// ai/application/review/HumanReviewService.ts
export class HumanReviewService {
  constructor(private readonly reviewRepository: ReviewRepository) {}

  async requireApproval(input: ReviewRequestInput): Promise<ReviewRequest> {
