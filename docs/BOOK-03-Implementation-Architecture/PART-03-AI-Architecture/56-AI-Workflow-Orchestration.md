...
next: "./57-Guardrails.md"
---

# AI Workflow Orchestration

> *"Defines how AI tasks are coordinated across workflows, queues, events, human approval, and retries."*
...
```ts
// ai/application/workflows/AiWorkflowService.ts
export class AiWorkflowService {
  constructor(private readonly workflowEngine: WorkflowEngine) {}

  async startCustomerReplyDraft(input: ReplyDraftWorkflowInput): Promise<void> {
    await this.workflowEngine.start({
      workflowName: "customer.reply_draft",
