...
next: "./49-Prompt-Architecture.md"
---

# Model Provider Abstraction

> *"Defines provider abstraction for OpenAI, Gemini, local models, and future AI model providers."*
...
```ts
// ai/application/ports/ModelProvider.ts
