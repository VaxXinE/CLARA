...
next: "./54-Tool-Calling.md"
---

# Memory Architecture

> *"Defines short-term memory, long-term memory, user preference memory, and safe memory retention rules."*
...
```ts
// ai/application/memory/AiMemoryService.ts
