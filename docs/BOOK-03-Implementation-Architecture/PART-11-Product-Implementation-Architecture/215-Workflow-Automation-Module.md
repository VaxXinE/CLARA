...
next: "./216-Notification-Module.md"
---

# Workflow Automation Module

> *"Defines implementation architecture for workflow definitions, triggers, conditions, actions, approvals, execution state, and auditability."*
...
```ts
// workflow/domain/WorkflowDefinition.ts
...
// workflow/application/WorkflowRunner.ts
export class WorkflowRunner {
  async run(definition: WorkflowDefinition, context: WorkflowContext): Promise<void> {
