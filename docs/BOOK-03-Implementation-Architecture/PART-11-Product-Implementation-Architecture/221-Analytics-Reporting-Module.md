...
previous: "./220-Admin-Console-Module.md"
next: "./222-Audit-Compliance-Module.md"
---

# Analytics Reporting Module

> *"Defines implementation architecture for dashboards, metrics, product analytics, business reporting, privacy-safe aggregation, and export."*
...
This chapter defines how **Analytics Reporting Module** should be implemented consistently.
...
Athena Analytics Reporting should use derived analytics models with privacy controls, tenant scope, and clear aggregation ownership.
...
```ts
// analytics/application/queries/GetDashboardMetricsQuery.ts
export class GetDashboardMetricsQueryHandler {
  ...
  async execute(query: GetDashboardMetricsQuery): Promise<DashboardMetricsDto> {
    await this.authorization.assertCan(query.actor, "analytics:read", {
      organizationId: query.organizationId,
      workspaceId: query.workspaceId,
    });

    return this.readModel.getDashboardMetrics({
      organizationId: query.organizationId,
      workspaceId: query.workspaceId,
