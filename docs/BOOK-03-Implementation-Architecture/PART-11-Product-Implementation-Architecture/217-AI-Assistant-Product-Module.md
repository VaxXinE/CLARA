...
chapter: "217"
title: "AI Assistant Product Module"
version: "1.0.0"
status: "official"
owner: "Athena Product Architecture Team"
last_updated: "2026-07-07"
classification: "implementation-architecture"
previous: "./216-Notification-Module.md"
next: "./218-Integration-Connector-Module.md"
---

# AI Assistant Product Module

> *"Defines implementation architecture for AI assistant product experiences, including chat, reply drafting, summarization, task assistance, and tool-assisted actions."*
...
This chapter defines how **AI Assistant Product Module** should be implemented consistently.
...
Athena AI Assistant product features should call the AI Gateway and never directly call model providers or execute tools without authorization.
...
```ts
// assistant/application/use-cases/DraftConversationReplyUseCase.ts
export class DraftConversationReplyUseCase {
  constructor(
  ...
  async execute(input: DraftReplyInput): Promise<DraftReplyOutput> {
    await this.authorization.assertCan(input.actor, "conversation:reply_draft", {
    ...
    return this.aiGateway.complete({
      capability: "conversation.reply_draft",
      actor: input.actor,
