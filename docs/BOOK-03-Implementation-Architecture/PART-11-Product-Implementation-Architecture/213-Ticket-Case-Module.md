...
chapter: "213"
title: "Ticket Case Module"
version: "1.0.0"
status: "official"
owner: "Athena Product Architecture Team"
last_updated: "2026-07-07"
classification: "implementation-architecture"
previous: "./212-Conversation-Inbox-Module.md"
next: "./214-Knowledge-Base-Module.md"
---

# Ticket Case Module

> *"Defines implementation architecture for ticketing, case management, priority, SLA, assignment, escalation, and resolution workflow."*
...
This chapter defines how **Ticket Case Module** should be implemented consistently.
...
Athena Ticket Case should model customer issues as stateful work items with ownership, SLA policy, workflow events, and audit trail.
...
```ts
// ticket/domain/entities/Ticket.ts
export class Ticket {
  constructor(
  ...
  assignTo(userId: string): void {
    if (this.status === "closed") {
      throw new DomainError("Closed ticket cannot be reassigned");
    }

    this.assigneeId = userId;
  }

  close(input: CloseTicketInput): void {
