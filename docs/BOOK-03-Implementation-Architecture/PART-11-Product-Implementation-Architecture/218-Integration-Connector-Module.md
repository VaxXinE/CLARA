...
Clara Integration Connector product module should expose connection management while delegating provider execution to Integration Architecture adapters.
