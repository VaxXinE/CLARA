...
next: "./211-Customer-CRM-Module.md"
---

# Role Permission Module

> *"Defines implementation architecture for roles, permissions, permission sets, resource access, and policy evaluation."*
...
export class Role {
  ...
  grants(permission: PermissionKey): boolean {
