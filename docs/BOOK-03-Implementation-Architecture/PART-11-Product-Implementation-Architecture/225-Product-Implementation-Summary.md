...
next: "../PART-12-Implementation-Roadmap/README.md"
---
...
Build modules around real product capabilities.
Keep domain ownership clear.
Keep permissions explicit.
Keep tenant scope everywhere.
Keep AI behind AI Gateway.
Keep integrations behind connectors.
Keep data classified.
Keep APIs versioned.
Keep UI permission-aware but not security-authoritative.
Keep tests and runbooks close to the module.
```
