...
chapter: "209"
title: "User Account Module"
version: "1.0.0"
status: "official"
owner: "Athena Product Architecture Team"
last_updated: "2026-07-07"
classification: "implementation-architecture"
previous: "./208-Workspace-Module.md"
next: "./210-Role-Permission-Module.md"
---

# User Account Module

> *"Defines implementation architecture for user accounts, profiles, membership, invitation, session ownership, and lifecycle."*
...
This chapter defines how **User Account Module** should be implemented consistently.
...
Athena User Account should separate global identity from organization/workspace membership and permission assignment.
...
```ts
// identity/domain/entities/UserAccount.ts
export class UserAccount {
  ...
  static invite(input: InviteUserProps): UserAccount {
  ...
  activate(): void {
    if (this.status !== "invited") {
      throw new DomainError("Only invited users can be activated");
    }
  }
}
```
