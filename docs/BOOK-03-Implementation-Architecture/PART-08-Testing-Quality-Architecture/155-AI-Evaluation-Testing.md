...
previous: "./154-Reliability-Testing.md"
next: "./156-Data-Testing.md"
---

# AI Evaluation Testing

> *"Defines AI evaluation testing for prompts, RAG, tool calling, safety, regression datasets, golden answers, and model/provider changes."*
...
This chapter defines how **AI Evaluation Testing** should be implemented consistently.
...
Athena AI behavior should be evaluated through deterministic datasets, policy tests, guardrail tests, and regression gates before production rollout.
...
```yaml
ai_evaluation:
  dataset: customer_support_reply_v1
  checks:
    - groundedness
    - policy_compliance
    - tone
