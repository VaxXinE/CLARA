...
previous: "./149-Integration-Testing.md"
next: "./151-End-to-End-Testing.md"
---

# Contract Testing

> *"Defines API and event contract testing for REST, GraphQL, webhooks, events, SDKs, and external integrations."*
...
This chapter defines how **Contract Testing** should be implemented consistently.
...
Athena public and cross-service interfaces should have contract tests to prevent breaking consumers.
