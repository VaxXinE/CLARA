...
previous: "./147-Test-Strategy.md"
next: "./149-Integration-Testing.md"
---

# Unit Testing

> *"Defines unit testing standards for domain logic, use cases, validators, mappers, state controllers, and pure functions."*
...
This chapter defines how **Unit Testing** should be implemented consistently.
...
Athena unit tests should be fast, isolated, deterministic, and focused on business behavior and edge cases.
...
describe("CustomerName", () => {
  ...
  it("rejects an empty customer name", () => {
    expect(() => CustomerName.create("")).toThrow(DomainError);
  });
});
```
