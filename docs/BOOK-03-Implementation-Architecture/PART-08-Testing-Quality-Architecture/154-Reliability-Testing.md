...
next: "./155-AI-Evaluation-Testing.md"
---

# Reliability Testing

> *"Defines reliability testing for retries, timeouts, circuit breakers, background jobs, queue processing, failover, and disaster recovery."*
...
```ts
describe("SendNotificationJobHandler", () => {
  it("does not send duplicate notification for same idempotency key", async () => {
