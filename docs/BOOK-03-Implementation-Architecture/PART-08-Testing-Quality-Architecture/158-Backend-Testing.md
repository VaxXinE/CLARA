...
previous: "./157-Frontend-Testing.md"
next: "./159-Test-Data-Management.md"
---

# Backend Testing

> *"Defines backend testing for domain models, use cases, repositories, controllers, queues, API contracts, and security-sensitive flows."*
...
This chapter defines how **Backend Testing** should be implemented consistently.
...
Athena backend tests should prioritize domain correctness, application authorization, transaction safety, repository behavior, and API contract stability.
...
describe("UpdateCustomerUseCase", () => {
  it("requires customer:update permission", async () => {
    authorization.assertCan.mockRejectedValue(new AuthorizationError("Access denied"));
