...
previous: "./158-Backend-Testing.md"
next: "./160-CI-Quality-Gates.md"
---

# Test Data Management

> *"Defines test data strategy, fixtures, factories, anonymized data, seed data, deterministic IDs, and data cleanup."*
...
This chapter defines how **Test Data Management** should be implemented consistently.
...
Athena test data should be deterministic, isolated, synthetic by default, and never depend on production customer data.
...
```ts
export function buildCustomerFixture(overrides: Partial<CustomerFixture> = {}): CustomerFixture {
  return {
    id: overrides.id ?? "00000000-0000-0000-0000-000000000001",
    organizationId: overrides.organizationId ?? testOrganizationId,
    workspaceId: overrides.workspaceId ?? testWorkspaceId,
