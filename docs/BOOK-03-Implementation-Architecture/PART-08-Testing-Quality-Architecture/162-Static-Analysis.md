...
previous: "./161-Code-Review-Quality.md"
next: "./163-Release-Readiness.md"
---

# Static Analysis

> *"Defines static analysis, linting, formatting, type checking, dependency analysis, secret scanning, and architecture rule enforcement."*
...
This chapter defines how **Static Analysis** should be implemented consistently.
...
Athena static analysis should run automatically and enforce code quality, security, and architecture constraints before merge.
...
```json
{
  "quality": {
    ...
    "typeCheck": "required",
    "secretScan": "required",
    "dependencyScan": "required",
    "architectureRules": "required"
  }
}
```
