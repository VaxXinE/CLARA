...
previous: "./148-Unit-Testing.md"
next: "./150-Contract-Testing.md"
---

# Integration Testing

> *"Defines integration testing standards for repositories, databases, queues, cache, object storage, and infrastructure adapters."*
...
This chapter defines how **Integration Testing** should be implemented consistently.
...
Athena integration tests should verify real boundaries using isolated test infrastructure and deterministic fixtures.
...
describe("PrismaCustomerRepository", () => {
  it("saves and loads customer with tenant scope", async () => {
    ...
    const loaded = await repository.findById(customer.id, {
      organizationId: orgId,
      workspaceId,
    });
