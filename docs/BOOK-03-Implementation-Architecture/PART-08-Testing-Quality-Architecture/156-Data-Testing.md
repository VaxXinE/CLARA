...
previous: "./155-AI-Evaluation-Testing.md"
next: "./157-Frontend-Testing.md"
---

# Data Testing

> *"Defines data testing for migrations, repositories, tenant isolation, retention, privacy masking, backups, search indexes, and vector filters."*
...
This chapter defines how **Data Testing** should be implemented consistently.
...
Athena data tests should protect schema evolution, data correctness, tenant isolation, privacy controls, and recoverability.
