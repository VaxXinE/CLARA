...
chapter: "180"
title: "Feature Flag Workflow"
version: "1.0.0"
status: "official"
owner: "Athena Developer Experience Team"
last_updated: "2026-07-07"
classification: "implementation-architecture"
previous: "./179-Developer-Tooling-CLI.md"
next: "./181-Architecture-Decision-Workflow.md"
---

# Feature Flag Workflow

> *"Defines feature flag lifecycle, naming, ownership, rollout, kill switch, cleanup, and production safety."*
...
This chapter defines how **Feature Flag Workflow** should be implemented consistently.
...
Athena feature flags should be owned, observable, temporary by default, and safe to disable quickly.
...
```ts
// platform/feature-flags/FeatureFlagService.ts
export class FeatureFlagService {
  ...
  async isEnabled(flagKey: string, context: FeatureFlagContext): Promise<boolean> {
    return this.provider.evaluate(flagKey, {
