...
Clara local development should be reproducible through scripted setup, containerized dependencies, validated configuration, and safe seed data.
...
services:
  postgres:
    ...
    environment:
      ...
      POSTGRES_USER: Clara
      POSTGRES_PASSWORD: Clara_dev_only
    ports:
      - "5432:5432"
