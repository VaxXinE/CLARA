...
previous: "./176-Package-Dependency-Management.md"
next: "./178-Debugging-Strategy.md"
---

# API Mocking Sandbox

> *"Defines API mocking, local sandbox services, contract stubs, fake providers, and safe frontend/backend parallel development."*
...
This chapter defines how **API Mocking Sandbox** should be implemented consistently.
...
Athena should provide mock APIs and sandbox providers based on contracts to support safe development without real production dependencies.
...
```ts
// tooling/mock-api/customerMock.ts
