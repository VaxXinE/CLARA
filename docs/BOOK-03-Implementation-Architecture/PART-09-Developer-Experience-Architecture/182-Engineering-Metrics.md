...
previous: "./181-Architecture-Decision-Workflow.md"
next: "./183-DevSecOps-Workflow.md"
---

# Engineering Metrics

> *"Defines engineering productivity, delivery quality, reliability, security, and developer friction metrics."*
...
This chapter defines how **Engineering Metrics** should be implemented consistently.
...
Athena engineering metrics should measure flow, quality, reliability, and security without incentivizing harmful shortcuts.
