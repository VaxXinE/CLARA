...
previous: "./172-Pull-Request-Workflow.md"
next: "./174-AI-Coding-Assistant-Workflow.md"
---

# Documentation Workflow

> *"Defines how documentation is created, reviewed, versioned, cross-referenced, and kept aligned with implementation."*
...
This chapter defines how **Documentation Workflow** should be implemented consistently.
...
Athena documentation should be treated as engineering source code with ownership, review, versioning, and change control.
...
documentation:
  required_for:
    ...
    - ai_capability_change

  review:
    required_owners:
      - architecture
      - security_when_sensitive
      - domain_owner
```
