...
previous: "./180-Feature-Flag-Workflow.md"
next: "./182-Engineering-Metrics.md"
---

# Architecture Decision Workflow

> *"Defines ADR creation, review, acceptance, supersession, linking, and implementation traceability."*
...
This chapter defines how **Architecture Decision Workflow** should be implemented consistently.
...
Athena architecture decisions should be captured as ADRs before or during implementation of significant technical choices.
