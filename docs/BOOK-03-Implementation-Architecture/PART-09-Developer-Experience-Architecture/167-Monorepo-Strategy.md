...
> *"Defines Clara monorepo structure, package ownership, dependency boundaries, shared libraries, and build orchestration."*
...
Clara should use a structured monorepo with explicit app, package, tooling, documentation, and infrastructure boundaries.
