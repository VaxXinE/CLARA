...
previous: "./174-AI-Coding-Assistant-Workflow.md"
next: "./176-Package-Dependency-Management.md"
---

# Code Generation Standards

> *"Defines standards for generated modules, scaffolding, templates, naming, tests, and security defaults."*
...
This chapter defines how **Code Generation Standards** should be implemented consistently.
...
Athena code generation should produce secure, testable, architecture-compliant skeletons instead of convenience-only boilerplate.
...
```text
Generated use case must include:
