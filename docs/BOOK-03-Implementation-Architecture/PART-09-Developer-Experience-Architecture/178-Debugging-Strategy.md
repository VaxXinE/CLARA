...
previous: "./177-API-Mocking-Sandbox.md"
next: "./179-Developer-Tooling-CLI.md"
---

# Debugging Strategy

> *"Defines local debugging, structured logs, correlation IDs, trace replay, feature flags, and safe production debugging."*
...
This chapter defines how **Debugging Strategy** should be implemented consistently.
...
Athena debugging should use observability-first workflows and avoid unsafe production inspection or sensitive data exposure.
...
1. Reproduce locally with safe fixture.
2. Check logs by correlation ID.
3. Check traces for slow boundary.
4. Check metrics for regression window.
5. Check recent releases and feature flags.
