...
previous: "./202-Customer-Support-Operations.md"
next: "./204-Postmortem-Continuous-Improvement.md"
---

# Maintenance Windows

> *"Defines planned maintenance, customer notification, risk review, rollback, verification, and post-maintenance reporting."*
...
This chapter defines how **Maintenance Windows** should be implemented consistently.
...
Athena planned maintenance should be scheduled, communicated, risk-reviewed, observable, and reversible where practical.
...
maintenance_window:
  requires:
    ...
    - expected_impact
    - rollback_plan
    - customer_notification_if_impacting
    - verification_plan
