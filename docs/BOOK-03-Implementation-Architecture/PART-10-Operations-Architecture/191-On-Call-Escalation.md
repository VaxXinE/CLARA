...
previous: "./190-Incident-Management.md"
next: "./192-Runbooks-Playbooks.md"
---

# On Call Escalation

> *"Defines on-call responsibilities, escalation policies, paging rules, handoff, and fatigue management."*
...
This chapter defines how **On Call Escalation** should be implemented consistently.
...
Athena on-call should page only for actionable customer-impacting issues and route alerts to clear owners.
...
on_call:
  ...
  paging_rules:
    ...
    do_not_page_for:
      - non_actionable_alert
      - low_priority_batch_delay
      - known_maintenance_window
```
