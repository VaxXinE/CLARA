...
previous: "./196-Operational-Monitoring.md"
next: "./198-Capacity-Planning.md"
---

# Alert Management

> *"Defines alert quality, routing, severity, deduplication, noise reduction, ownership, and alert lifecycle."*
...
This chapter defines how **Alert Management** should be implemented consistently.
...
Athena alerts should be actionable, owned, severity-classified, deduplicated, and tied to runbooks.
...
```yaml
alert:
  name: api_error_budget_burn
  severity: critical
  owner: backend-platform
  condition: "burn_rate > 14x for 5m"
  runbook: runbooks/api-error-budget-burn.md
