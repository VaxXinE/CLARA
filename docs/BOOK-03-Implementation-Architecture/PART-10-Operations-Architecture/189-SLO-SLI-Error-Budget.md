...
previous: "./188-Service-Ownership.md"
next: "./190-Incident-Management.md"
---

# SLO SLI Error Budget

> *"Defines service level indicators, service level objectives, error budgets, reliability targets, and customer-impact measurement."*
...
This chapter defines how **SLO SLI Error Budget** should be implemented consistently.
...
Athena critical services should define SLIs and SLOs that measure customer-visible reliability and guide release/risk decisions.
...
```yaml
slos:
  athena_api_availability:
    sli: successful_requests / total_requests
    objective: "99.9%"
    window: "30d"
    error_budget_policy:
      burn_rate_alert: true
      freeze_high_risk_releases_when_exhausted: true

  customer_api_latency:
    sli: p95_request_latency_ms
    objective: "< 300ms"
    window: "7d" 
```
