...
Clara incidents should be managed through a documented lifecycle with clear severity, incident commander, communication channel, and post-incident actions.
