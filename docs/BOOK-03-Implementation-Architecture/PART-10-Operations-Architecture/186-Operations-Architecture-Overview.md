...
previous: "./README.md"
next: "./187-SRE-Operating-Model.md"
---
...
If it runs in production, it needs an owner.
If it can fail, it needs an alert.
If it has an alert, it needs a runbook.
If it causes customer impact, it needs an incident process.
If it repeats, it needs automation.
If it teaches us something, it needs a postmortem.
```
