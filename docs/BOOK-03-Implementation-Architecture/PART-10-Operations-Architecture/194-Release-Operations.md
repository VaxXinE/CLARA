...
previous: "./193-Change-Management.md"
next: "./195-Production-Access-Operations.md"
---

# Release Operations

> *"Defines operational release process, release windows, canary analysis, rollback criteria, feature flags, and production verification."*
...
This chapter defines how **Release Operations** should be implemented consistently.
...
Athena releases should use automated deployment, staged rollout, production verification, and explicit rollback thresholds.
...
release_operations:
  strategy:
    default: rolling
    high_risk: canary
    emergency_fix: hotfix

  verification:
    - health_check
    - smoke_test
    - slo_dashboard_review
    - error_rate_check
    - latency_check
