...
previous: "./192-Runbooks-Playbooks.md"
next: "./194-Release-Operations.md"
---

# Change Management

> *"Defines production change control, risk assessment, approval rules, rollout safety, rollback planning, and change auditability."*
...
This chapter defines how **Change Management** should be implemented consistently.
...
Athena production changes should be risk-classified, reviewed, traceable, and reversible where practical.
...
change_management:
  risk_levels:
    ...
    high:
      approval: service_owner_and_platform
    critical:
      approval: architecture_security_and_incident_commander

  required_for_high_risk:
    - rollback_plan
    - observability_check
    - customer_impact_assessment
    - maintenance_window_if_needed
```
