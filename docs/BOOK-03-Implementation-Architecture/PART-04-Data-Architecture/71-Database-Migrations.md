...
previous: "./70-Data-Access-Patterns.md"
next: "./72-Consistency-Model.md"
---

# Database Migrations

> *"Defines migration standards, backward compatibility, rollback strategy, zero-downtime migration, and migration review."*
...
This chapter defines how **Database Migrations** should be implemented safely and consistently.
...
Athena database migrations should be versioned, reviewed, reversible where practical, and safe for rolling deployments.
...
```ts
-- 202607070001_add_customer_phone.sql

ALTER TABLE customers
  ADD COLUMN phone VARCHAR(32);

CREATE INDEX CONCURRENTLY idx_customers_phone
  ON customers (organization_id, workspace_id, phone);

-- Backfill should run separately for large tables.
