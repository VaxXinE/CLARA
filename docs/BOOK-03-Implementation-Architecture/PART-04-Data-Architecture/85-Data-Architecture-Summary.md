...
next: "../PART-05-Integration-Architecture/README.md"
---
...
This chapter defines how **Data Architecture Summary** should be implemented safely and consistently.
...
```ts
// Data architecture rule of thumb:
//
// Transactional DB owns source-of-truth records.
// Event store owns business facts.
// Search index owns discoverability.
// Vector DB owns semantic retrieval.
// Object storage owns binary objects.
// Cache owns temporary acceleration.
// Analytics owns reporting projections.
// Audit owns investigation evidence.
