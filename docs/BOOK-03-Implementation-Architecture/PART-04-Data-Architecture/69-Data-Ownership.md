...
next: "./70-Data-Access-Patterns.md"
---

# Data Ownership

> *"Defines domain ownership of tables, read models, events, documents, vector indexes, and derived data."*
...
This chapter defines how **Data Ownership** should be implemented safely and consistently.
...
```ts
// data/domain/DataOwner.ts
export type DataOwner = {
  domain: "customer" | "conversation" | "knowledge" | "billing" | "ai";
  stewardTeam: string;
...
export const customerDataOwner: DataOwner = {
  domain: "customer",
  stewardTeam: "CRM Platform",
  classification: "confidential",
  retentionPolicy: "customer-retention-v1",
  accessPolicy: "tenant-scoped-rbac",
};
