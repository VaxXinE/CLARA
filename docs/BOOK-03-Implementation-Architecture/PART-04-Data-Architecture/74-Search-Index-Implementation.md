...
next: "./75-Vector-Database-Implementation.md"
---

# Search Index Implementation

> *"Defines full-text search indexing, synchronization, reindexing, search permissions, and stale index handling."*
...
This chapter defines how **Search Index Implementation** should be implemented safely and consistently.
...
```ts
// search/application/SearchIndexer.ts
export class SearchIndexer {
  constructor(private readonly searchStore: SearchStore) {}

  async indexCustomer(customer: CustomerSearchDocument): Promise<void> {
    await this.searchStore.upsert({
      index: "customers",
      id: customer.id,
      tenant: {
