...
next: "./77-Cache-Store-Implementation.md"
---

# Object Storage Implementation

> *"Defines object storage, file metadata, signed URLs, malware scanning, access control, and lifecycle rules."*
...
This chapter defines how **Object Storage Implementation** should be implemented safely and consistently.
...
```ts
// storage/application/ObjectStorageService.ts
export class ObjectStorageService {
  ...
  async createSignedDownloadUrl(input: SignedUrlInput): Promise<string> {
    await this.metadataRepository.assertReadable(input.fileId, input.actor);

    return this.objectStore.createSignedUrl({
      key: input.objectKey,
