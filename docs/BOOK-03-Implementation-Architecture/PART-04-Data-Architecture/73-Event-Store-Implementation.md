...
next: "./74-Search-Index-Implementation.md"
---

# Event Store Implementation

> *"Defines event store implementation, event schema, ordering, idempotency, replay, and event retention."*
...
This chapter defines how **Event Store Implementation** should be implemented safely and consistently.
