...
next: "./73-Event-Store-Implementation.md"
---

# Consistency Model

> *"Defines consistency boundaries, transactional guarantees, eventual consistency, outbox usage, and read-after-write expectations."*
...
This chapter defines how **Consistency Model** should be implemented safely and consistently.
...
```ts
// platform/outbox/OutboxWriter.ts
export class OutboxWriter {
  constructor(private readonly db: DatabaseClient) {}

  async add(event: DomainEvent, tx: Transaction): Promise<void> {
