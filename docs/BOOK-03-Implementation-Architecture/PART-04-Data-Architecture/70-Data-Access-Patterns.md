...
next: "./71-Database-Migrations.md"
---

# Data Access Patterns

> *"Defines repository, query model, pagination, filtering, sorting, and safe data retrieval patterns."*
...
This chapter defines how **Data Access Patterns** should be implemented safely and consistently.
...
```ts
// customer/application/ports/CustomerReadModel.ts
export interface CustomerReadModel {
  list(input: ListCustomersQuery): Promise<PaginatedResult<CustomerListItemDto>>;
}

// customer/infrastructure/read-models/PostgresCustomerReadModel.ts
export class PostgresCustomerReadModel implements CustomerReadModel {
  async list(input: ListCustomersQuery): Promise<PaginatedResult<CustomerListItemDto>> {
    return queryWithTenantScope({
