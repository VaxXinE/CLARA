...
next: "./82-Data-Privacy.md"
---

# Data Retention

> *"Defines retention policies, deletion windows, archival, legal hold, and lifecycle automation."*
...
This chapter defines how **Data Retention** should be implemented safely and consistently.
...
```ts
// data-governance/domain/RetentionPolicy.ts
export type RetentionPolicy = {
  ...
  deletionMode: "hard-delete" | "soft-delete" | "anonymize";
};
