...
next: "./76-Object-Storage-Implementation.md"
---

# Vector Database Implementation

> *"Defines vector database usage, embeddings, metadata filters, tenant isolation, chunk identity, and retrieval safety."*
...
This chapter defines how **Vector Database Implementation** should be implemented safely and consistently.
...
```ts
// knowledge/application/VectorSearchService.ts
export class VectorSearchService {
  constructor(private readonly vectorStore: VectorStore) {}

  async search(input: VectorSearchInput): Promise<KnowledgeChunk[]> {
    return this.vectorStore.search({
      ...
      filters: {
        ...
        accessLevel: input.allowedAccessLevels,
      },
    });
  }
}
