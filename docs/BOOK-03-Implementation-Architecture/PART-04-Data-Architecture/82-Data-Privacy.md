...
next: "./83-Audit-Data.md"
---

# Data Privacy

> *"Defines privacy-safe data handling, PII classification, minimization, masking, export, deletion, and consent-aware processing."*
...
This chapter defines how **Data Privacy** should be implemented safely and consistently.
...
```ts
// privacy/application/PiiMasker.ts
