...
This chapter defines how **Container Architecture** should be implemented safely and consistently for Clara.
...
Clara services should run as minimal, non-root, versioned container images with reproducible builds and security scanning.
