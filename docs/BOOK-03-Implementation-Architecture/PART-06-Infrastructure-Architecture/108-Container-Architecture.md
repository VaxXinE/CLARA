...
previous: "./107-Deployment-Architecture.md"
next: "./109-Kubernetes-Architecture.md"
---

# Container Architecture

> *"Defines container image standards, Dockerfile practices, runtime user, dependency isolation, and image security."*
...
This chapter defines how **Container Architecture** should be implemented safely and consistently for Athena.
...
Athena services should run as minimal, non-root, versioned container images with reproducible builds and security scanning.
