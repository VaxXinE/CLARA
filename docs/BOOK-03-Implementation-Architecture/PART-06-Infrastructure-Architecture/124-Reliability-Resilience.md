...
next: "./125-Infrastructure-Summary.md"
---

# Reliability Resilience

> *"Defines resilience patterns including timeouts, retries, circuit breakers, bulkheads, graceful degradation, and chaos testing."*
...
```yaml
// platform/resilience/ExternalCallPolicy.ts
export const externalCallPolicy = {
  timeoutMs: 5000,
  retry: {
    maxAttempts: 3,
    backoff: "exponential",
