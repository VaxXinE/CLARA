...
previous: "./README.md"
next: "./107-Deployment-Architecture.md"
---
...
```yaml
# Infrastructure rule of thumb:
#
# Source code defines application behavior.
# Infrastructure as Code defines runtime shape.
# CI/CD defines delivery safety.
# Observability defines production visibility.
# Security policy defines trust boundaries.
# Runbooks define operational recovery.
