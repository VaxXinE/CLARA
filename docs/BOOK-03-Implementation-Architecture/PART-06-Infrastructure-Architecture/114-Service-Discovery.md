...
next: "./115-Secrets-Management.md"
---

# Service Discovery

> *"Defines service discovery, internal DNS, service registry, endpoint resolution, and runtime dependency discovery."*
...
```yaml
// platform/service-discovery/ServiceResolver.ts
export class ServiceResolver {
  resolve(serviceName: string): string {
    ...
    return `http://${normalized}.svc.cluster.local`;
  }
}
