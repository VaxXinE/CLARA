...
next: "./116-Runtime-Configuration.md"
---

# Secrets Management

> *"Defines runtime secrets storage, rotation, injection, access control, and secret leak prevention."*
...
```yaml
// platform/secrets/SecretProvider.ts
