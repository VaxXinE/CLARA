...
next: "./108-Container-Architecture.md"
---

# Deployment Architecture

> *"Defines deployment topology, release strategy, rollback behavior, deployment units, and production promotion flow."*
...
deployment:
  strategy: rolling
  rollback: automatic_on_failed_healthcheck
  artifact: immutable_container_image
