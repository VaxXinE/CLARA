...
> *"Defines domain events as immutable business facts emitted by domain behavior and consumed by application or platform handlers."*
...
- Decouples business state changes from side effects.
- Creates a consistent event-driven foundation.
- Supports audit, workflow automation, analytics, and integrations.
- Improves traceability of business changes.
...
```ts
// customer/domain/events/CustomerCreated.ts
