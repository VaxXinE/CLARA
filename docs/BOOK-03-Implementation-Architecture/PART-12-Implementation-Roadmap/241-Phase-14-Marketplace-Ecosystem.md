...
next: "./242-Migration-Legacy-Strategy.md"
---

# Phase 14 Marketplace Ecosystem

> *"Defines marketplace and ecosystem readiness including plugin review, extension SDK, connector certification, package signing, and tenant installation governance."*
...
marketplace_ecosystem:
  required:
    ...
    - package_signing
    - permission_review
    - marketplace_review_workflow
    - tenant_install_controls
    - package_versioning
    - abuse_response_process
```
