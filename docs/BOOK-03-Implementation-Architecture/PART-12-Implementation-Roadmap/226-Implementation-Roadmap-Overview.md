...
previous: "./README.md"
next: "./227-Phase-0-Repository-Foundation.md"
---
...
```text
Implementation roadmap rule of thumb:

Do not build everything at once.
Build the foundation first.
Secure the foundation early.
Validate architecture continuously.
Release through evidence, not hope.
Use phases to reduce risk.
Use exit criteria to prevent fake progress.
```
