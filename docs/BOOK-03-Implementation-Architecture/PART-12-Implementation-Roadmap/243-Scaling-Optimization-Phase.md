...
next: "./244-Governance-Continuous-Improvement.md"
---

# Scaling Optimization Phase

> *"Defines scaling optimization after production usage, including performance tuning, capacity planning, cost optimization, and reliability improvements."*
...
scaling_optimization:
  ...
  actions:
    - optimize_queries
    - tune_cache
    - improve_worker_scaling
    - reduce_ai_context_size
    - archive_old_data
    - review_infrastructure_cost
```
