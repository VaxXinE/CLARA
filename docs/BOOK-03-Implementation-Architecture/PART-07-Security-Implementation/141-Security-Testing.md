...
previous: "./140-Vulnerability-Management.md"
next: "./142-Audit-Logging-Security.md"
---

# Security Testing

> *"Defines security test strategy including SAST, DAST, dependency scanning, secret scanning, penetration testing, and abuse-case tests."*
...
This chapter defines how **Security Testing** should be implemented safely and consistently.
...
Athena security testing should be automated in CI/CD and supplemented with manual review for high-risk features.
