...
previous: "./127-Identity-Access-Management.md"
next: "./129-Authorization-Implementation.md"
---

# Authentication Implementation

> *"Defines authentication flows, session handling, MFA readiness, token validation, passwordless support, and login security."*
...
This chapter defines how **Authentication Implementation** should be implemented safely and consistently.
...
Athena authentication should use centralized session issuance, strong token validation, secure cookie/token handling, and MFA-ready design.
...
```ts
// security/auth/SessionService.ts
export class SessionService {
  ...
  async createSession(input: CreateSessionInput): Promise<SessionTokenPair> {
    ...
    return this.tokenSigner.signSessionTokens({
