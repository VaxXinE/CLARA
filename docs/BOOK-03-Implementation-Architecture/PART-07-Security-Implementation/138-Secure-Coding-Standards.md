...
previous: "./137-Input-Validation-Sanitization.md"
next: "./139-Threat-Modeling.md"
---

# Secure Coding Standards

> *"Defines secure coding rules for backend, frontend, AI, data, integration, and infrastructure implementation."*
...
This chapter defines how **Secure Coding Standards** should be implemented safely and consistently.
...
Athena code should follow secure-by-default patterns and fail closed when security context is missing or invalid.
