...
previous: "./136-Secrets-Security.md"
next: "./138-Secure-Coding-Standards.md"
---

# Input Validation Sanitization

> *"Defines input validation, sanitization boundaries, output encoding, file validation, and injection prevention."*
...
This chapter defines how **Input Validation Sanitization** should be implemented safely and consistently.
...
Athena should validate input at boundaries, preserve domain invariants internally, and encode output at rendering boundaries.
...
```ts
// security/validation/safeHtml.ts
export function sanitizeUserHtml(input: string): string {
  return sanitizeHtml(input, {
    allowedTags: ["b", "i", "strong", "em", "p", "ul", "ol", "li", "a"],
    allowedAttributes: {
