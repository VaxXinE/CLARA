...
previous: "./128-Authentication-Implementation.md"
next: "./130-RBAC-ABAC.md"
---

# Authorization Implementation

> *"Defines server-side authorization checks, permission evaluation, resource-level access, and policy enforcement."*
...
This chapter defines how **Authorization Implementation** should be implemented safely and consistently.
...
Athena authorization should be enforced server-side inside application use cases and sensitive infrastructure adapters.
...
```ts
// security/authz/AuthorizationService.ts
export class AuthorizationService {
  constructor(private readonly policyEngine: PolicyEngine) {}

  async assertCan(actor: Actor, permission: string, resource: ResourceContext): Promise<void> {
