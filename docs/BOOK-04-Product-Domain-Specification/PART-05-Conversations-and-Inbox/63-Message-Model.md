...
previous: "62-Conversation-Model.md"
next: "64-Channel-Model.md"
---

# Message Model

> *"Defines inbound, outbound, internal, system, and AI-generated message behavior."*
...
Messages are communication records. If they can be freely modified, teams lose trust, history, and auditability.
...
CLARA Message should be immutable after delivery except for metadata, moderation state, or internal correction workflows.
...
| `message:send` | Product action permission | Protected by backend authorization |
| `message:create_internal` | Product action permission | Protected by backend authorization |
...
MVP must support inbound messages, outbound replies, internal notes, system messages, and delivery status basics.

---

# Future Behavior

Future versions may support edits, redactions, reactions, rich media, translation, and message-level moderation.
