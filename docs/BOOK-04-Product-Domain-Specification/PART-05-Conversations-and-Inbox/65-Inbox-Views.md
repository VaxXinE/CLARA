...
previous: "64-Channel-Model.md"
next: "66-Conversation-Assignment.md"
---

# Inbox Views

> *"Defines how users view conversations through inbox queues, filters, tabs, and saved views."*
...
Agents and managers need fast ways to find work without being overwhelmed by all conversations.
...
CLARA Inbox should provide simple operational views first: open, assigned to me, unassigned, resolved, and all accessible conversations.
...
| `inbox_view:read` | Product action permission | Protected by backend authorization |
| `inbox_view:create` | Product action permission | Protected by backend authorization |
...
MVP must support Open, Assigned to Me, Unassigned, and Resolved views with basic filtering.

---

# Future Behavior

Future versions may support custom views, team queues, channel-specific views, SLA views, and saved filters.
