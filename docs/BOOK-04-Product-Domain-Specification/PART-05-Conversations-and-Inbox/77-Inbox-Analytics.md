...
previous: "76-Conversation-Notifications.md"
next: "78-Conversation-Privacy-and-Retention.md"
---

# Inbox Analytics

> *"Defines analytics derived from conversations and inbox activity."*
...
Managers need visibility into volume, response time, backlog, and resolution trends.
...
CLARA Inbox Analytics should provide operational insight without exposing unnecessary message-level sensitive data.
...
MVP may show basic counts such as open conversations, assigned conversations, and resolved conversations.

---

# Future Behavior

Future versions may support response-time metrics, SLA metrics, team performance, channel trends, and AI impact analytics.
