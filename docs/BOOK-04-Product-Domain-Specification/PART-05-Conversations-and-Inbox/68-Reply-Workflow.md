...
previous: "67-Conversation-Status-Lifecycle.md"
next: "69-AI-Reply-Drafting.md"
---

# Reply Workflow

> *"Defines how users compose, preview, send, and track replies to customer messages."*
...
Replying is a high-impact customer action. Users need clarity before sending, and the system must avoid sending duplicate or unauthorized replies.
...
CLARA Reply Workflow should make human-authored replies explicit, safe, permission-controlled, and channel-aware.
...
MVP must support text reply composition, send action, delivery status, and error handling.

---

# Future Behavior

Future versions may support templates, rich text, attachments, approval before send, scheduled replies, and channel-specific formatting.
