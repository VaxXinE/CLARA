...
chapter: "136"
title: "AI Permissions and Access Control"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "135-AI-Audit-and-Traceability.md"
next: "137-AI-Error-Handling-and-Fallbacks.md"
---

# AI Permissions and Access Control

> *"Defines authorization behavior for AI features."*
...
AI must not become a shortcut around normal product permissions.
...
CLARA AI permissions should be explicit and must inherit actor resource permissions for context retrieval and tool execution.
...
| `ai.permission:read` | Product action permission | Protected by backend authorization |
...
MVP must require AI feature permission plus underlying resource permission for the data being used.

---

# Future Behavior

Future versions may support per-feature AI toggles, model access policies, tool-specific approval rules, and tenant-level AI controls.
