...
chapter: "132"
title: "Prompt and Context Policy"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "131-AI-Safety-Guardrails.md"
next: "133-AI-Memory-and-Context-Boundaries.md"
---

# Prompt and Context Policy

> *"Defines how prompts and context are constructed, limited, stored, and protected."*
...
Prompt and context design directly affects AI output quality, privacy, and security.
...
CLARA should treat prompts, system instructions, and retrieved context as sensitive operational data.
...
|---|---|---|
| `ai.prompt:read` | Product action permission | Protected by backend authorization |
| `ai.prompt:update` | Product action permission | Protected by backend authorization |
...
MVP must use controlled prompt templates and scoped context assembly with sensitive-data minimization.

---

# Future Behavior

Future versions may support prompt versioning, prompt experiments, prompt evaluation, and policy-based context assembly.
