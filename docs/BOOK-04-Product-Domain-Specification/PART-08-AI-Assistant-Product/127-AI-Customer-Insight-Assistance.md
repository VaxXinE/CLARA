...
chapter: "127"
title: "AI Customer Insight Assistance"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "126-AI-Ticket-Assistance-Product-Behavior.md"
next: "128-AI-Knowledge-Grounding.md"
---

# AI Customer Insight Assistance

> *"Defines AI-generated customer insights based on Customer CRM, conversations, tickets, and timeline data."*
...
Users need fast customer understanding, but AI insights may overstate conclusions or reveal sensitive details.
...
CLARA AI Customer Insight should summarize customer context and risks without exposing data outside actor permissions.
...
|---|---|---|
| `ai.customer_insight:create` | Product action permission | Protected by backend authorization |
...
MVP may provide simple customer context summary using recent accessible data.

---

# Future Behavior

Future versions may support churn signals, sentiment trends, sales opportunity hints, and health-score explanations.
