...
previous: "121-AI-Assistant-Product-Overview.md"
next: "123-AI-Chat-Experience.md"
---

# AI Assistant Use Cases

> *"Defines the primary use cases CLARA AI Assistant should support across CRM, Inbox, Ticketing, Knowledge, and Operations."*
...
If AI use cases are too broad early, the product becomes hard to evaluate, secure, and trust.
...
CLARA AI Assistant use cases should prioritize high-frequency, low-risk assistance before autonomous execution.
...
| `ai.use_case:read` | Product action permission | Protected by backend authorization |
...
MVP should focus on reply drafting, summarization, knowledge lookup, and simple ticket/customer context assistance.

---

# Future Behavior

Future versions may add workflow recommendations, automation creation, customer insights, and quality coaching.
