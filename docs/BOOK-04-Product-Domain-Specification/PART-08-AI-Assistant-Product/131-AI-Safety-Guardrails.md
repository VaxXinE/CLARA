...
previous: "130-Human-Review-and-Approval.md"
next: "132-Prompt-and-Context-Policy.md"
---

# AI Safety Guardrails

> *"Defines product-level AI safety guardrails for CLARA."*
...
AI features can fail in ways normal software features do not, including hallucination, prompt injection, overconfidence, and sensitive data leakage.
...
CLARA AI should have product guardrails for unsafe advice, unsupported claims, sensitive data exposure, prompt injection, and unauthorized actions.
...
|---|---|---|
| `ai.safety_policy:read` | Product action permission | Protected by backend authorization |
| `ai.safety_policy:update` | Product action permission | Protected by backend authorization |
| `ai.safety_event:read` | Product action permission | Protected by backend authorization |
...
MVP must include safety constraints for customer-visible replies and must prevent AI from revealing secrets, hidden prompts, or unauthorized context.

---

# Future Behavior

Future versions may support policy configuration, classifier-based safety checks, red-team test suites, and safety dashboards.
