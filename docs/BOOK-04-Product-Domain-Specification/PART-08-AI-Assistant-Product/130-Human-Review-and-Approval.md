...
previous: "129-AI-Tool-Actions.md"
next: "131-AI-Safety-Guardrails.md"
---

# Human Review and Approval

> *"Defines when human review is required before AI output is sent or actions are executed."*
...
AI can be helpful but wrong. Users need control before AI affects customers or business records.
...
CLARA should require human approval for customer-visible AI output and sensitive data-changing actions in MVP.
...
|---|---|---|
| `ai.review:create` | Product action permission | Protected by backend authorization |
| `ai.review:approve` | Product action permission | Protected by backend authorization |
| `ai.review:reject` | Product action permission | Protected by backend authorization |
...
MVP must require human review before sending AI-generated customer replies.

---

# Future Behavior

Future versions may support approval queues, risk-based approvals, manager review, and policy-based auto-approval for low-risk tasks.
