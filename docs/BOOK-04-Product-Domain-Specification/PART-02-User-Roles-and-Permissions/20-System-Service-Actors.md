...
chapter: "20"
title: "System Service Actors"
version: "1.0.0"
status: "official"
owner: "Clara Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "19-Developer-Integrator-Role.md"
next: "21-Role-Model.md"
---

# System Service Actors

> *"Defines non-human actors such as background jobs, webhooks, AI tools, connectors, and internal services."*
...
Automated actions can change data or call external systems. Without explicit service actors, automation can become invisible and unsafe.
...
Clara should model system/service actors explicitly with service identity, scoped permissions, auditability, and least privilege.
...
|---|---|---|
| `service:execute` | Product action permission | MVP/Future based on module |
| `webhook:ingest` | Product action permission | MVP/Future based on module |
| `job:process` | Product action permission | MVP/Future based on module |
| `ai.tool:execute` | Product action permission | MVP/Future based on module |
| `integration.sync:run` | Product action permission | MVP/Future based on module |
...
MVP must distinguish human user actions from system/service actions in audit logs.

---

# Future Behavior

Future versions may support service accounts, scoped machine tokens, and per-service access policies.
