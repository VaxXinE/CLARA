...
chapter: "16"
title: "Support Agent Role"
version: "1.0.0"
status: "official"
owner: "Clara Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "15-Manager-Role.md"
next: "17-Sales-Operator-Role.md"
---

# Support Agent Role

> *"Defines the role responsible for handling customer conversations, drafting replies, resolving support issues, and escalating tickets."*
...
Support agents need customer context and AI assistance to respond quickly, but should not access admin settings or unrelated sensitive data.
...
Clara Support Agent should focus on customer communication workflows with permission-limited access to customer context, conversations, tickets, and AI assistance.
...
|---|---|---|
| `customer:read` | Product action permission | MVP/Future based on module |
| `conversation:read` | Product action permission | MVP/Future based on module |
| `conversation:reply` | Product action permission | MVP/Future based on module |
| `conversation:assign_self` | Product action permission | MVP/Future based on module |
| `ticket:update` | Product action permission | MVP/Future based on module |
| `ai.reply_draft:create` | Product action permission | MVP/Future based on module |
| `knowledge:read` | Product action permission | MVP/Future based on module |
...
MVP must allow Support Agent to read assigned conversations, draft replies, send replies, use knowledge, and update ticket state.

---

# Future Behavior

Future versions may support skill-based routing, quality review, and restricted customer segments.
