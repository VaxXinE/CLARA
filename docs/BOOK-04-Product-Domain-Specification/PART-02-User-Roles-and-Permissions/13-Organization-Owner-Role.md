...
previous: "12-User-Personas.md"
next: "14-Admin-Role.md"
---

# Organization Owner Role

> *"Defines the highest business authority role inside an Clara Organization."*
...
Every organization needs one or more accountable owners who can control business-critical settings without relying on engineering support.
...
Clara should treat Organization Owner as the accountable role for billing, organization-level settings, ownership transfer, and high-risk administrative decisions.
...
|---|---|---|
| `organization:read` | Product action permission | MVP/Future based on module |
| `organization:update` | Product action permission | MVP/Future based on module |
| `billing:manage` | Product action permission | MVP/Future based on module |
| `owner:transfer` | Product action permission | MVP/Future based on module |
| `admin:manage` | Product action permission | MVP/Future based on module |
...
MVP must support an Organization Owner role with organization-level administration and billing access.

---

# Future Behavior

Future versions may support multiple owners, ownership transfer approval, and enterprise governance policies.
