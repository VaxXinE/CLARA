...
chapter: "18"
title: "Knowledge Manager Role"
version: "1.0.0"
status: "official"
owner: "Clara Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "17-Sales-Operator-Role.md"
next: "19-Developer-Integrator-Role.md"
---

# Knowledge Manager Role

> *"Defines the role responsible for creating, reviewing, publishing, and maintaining knowledge content used by users and AI."*
...
AI assistance and human support quality depend on trusted knowledge, so someone must own article quality and publication.
...
Clara Knowledge Manager should control knowledge quality, publishing, versioning, and AI grounding content without unrestricted system administration.
...
| `knowledge:create` | Product action permission | MVP/Future based on module |
| `knowledge:update` | Product action permission | MVP/Future based on module |
| `knowledge:publish` | Product action permission | MVP/Future based on module |
| `knowledge:archive` | Product action permission | MVP/Future based on module |
| `ai.grounding:review` | Product action permission | MVP/Future based on module |
...
MVP must allow Knowledge Manager to create, edit, publish, archive, and review knowledge articles used by AI reply drafting.

---

# Future Behavior

Future versions may support approval workflows, article quality scores, freshness reminders, and multilingual knowledge.
