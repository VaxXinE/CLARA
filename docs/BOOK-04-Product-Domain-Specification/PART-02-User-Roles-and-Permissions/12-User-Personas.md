...
previous: "11-User-Roles-Permissions-Overview.md"
next: "13-Organization-Owner-Role.md"
---

# User Personas

> *"Defines Clara's primary product personas and their goals, pain points, workflows, and access needs."*
...
Without clear personas, Clara may build features that are technically complete but hard for real teams to use.
...
Clara should design user experience and permissions around real business personas rather than generic account types.
...
|---|---|---|
| `persona:read` | Product action permission | MVP/Future based on module |
...
MVP must document the primary personas and use them to guide navigation, default roles, and onboarding.

---

# Future Behavior

Future versions may support industry-specific personas and configurable onboarding journeys.
