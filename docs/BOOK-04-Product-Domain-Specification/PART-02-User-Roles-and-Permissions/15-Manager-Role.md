...
previous: "14-Admin-Role.md"
next: "16-Support-Agent-Role.md"
---

# Manager Role

> *"Defines the role responsible for supervising teams, monitoring work, assigning conversations/tickets, and reviewing performance."*
...
Managers need enough visibility and control to run daily operations, but should not have access to every organization-level setting.
...
Clara Manager should have team-level operational visibility and assignment capabilities without unrestricted administrative control.
...
| `conversation:assign` | Product action permission | MVP/Future based on module |
| `ticket:read` | Product action permission | MVP/Future based on module |
| `ticket:assign` | Product action permission | MVP/Future based on module |
| `analytics:read` | Product action permission | MVP/Future based on module |
| `team:read` | Product action permission | MVP/Future based on module |
...
MVP must support Manager visibility over assigned workspace workflows and team performance.

---

# Future Behavior

Future versions may support team-specific scope, SLA configuration, and manager approval workflows.
