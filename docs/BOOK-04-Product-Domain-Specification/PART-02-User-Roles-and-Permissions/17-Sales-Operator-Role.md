...
chapter: "17"
title: "Sales Operator Role"
version: "1.0.0"
status: "official"
owner: "Clara Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "16-Support-Agent-Role.md"
next: "18-Knowledge-Manager-Role.md"
---

# Sales Operator Role

> *"Defines the role responsible for managing leads, customer follow-ups, sales conversations, and pipeline-oriented workflows."*
...
Sales users need CRM and conversation context, but their permissions should be separated from support operations and admin settings.
...
Clara Sales Operator should access customer and conversation workflows relevant to acquisition and follow-up without receiving support/admin-only privileges.
...
| `customer:update` | Product action permission | MVP/Future based on module |
...
| `task:create` | Product action permission | MVP/Future based on module |
| `ai.summary:create` | Product action permission | MVP/Future based on module |
...
MVP should allow sales operators to view and update customer records and participate in relevant conversations.

---

# Future Behavior

Future versions may include pipeline stages, opportunity objects, forecasting, and CRM import/export controls.
