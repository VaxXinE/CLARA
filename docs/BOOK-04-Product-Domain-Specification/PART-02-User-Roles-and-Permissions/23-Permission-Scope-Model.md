...
chapter: "23"
title: "Permission Scope Model"
version: "1.0.0"
status: "official"
owner: "Clara Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "22-Permission-Catalog.md"
next: "24-Access-Review-and-Delegation.md"
---

# Permission Scope Model

> *"Defines how permissions are scoped by Organization, Workspace, resource ownership, team, and system context."*
...
A user may be allowed to perform an action in one workspace but not another. Permission without scope can leak data.
...
Clara permissions should always be evaluated with scope, not only with action names.
...
|---|---|---|
| `access_policy:evaluate` | Product action permission | MVP/Future based on module |
| `scope:read` | Product action permission | MVP/Future based on module |
...
MVP must evaluate permissions with Organization and Workspace scope for all protected actions.

---

# Future Behavior

Future versions may support team scope, object-level ownership scope, conditional access, and ABAC.
