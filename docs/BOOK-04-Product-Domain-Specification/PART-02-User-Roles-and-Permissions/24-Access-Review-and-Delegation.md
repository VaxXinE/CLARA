...
chapter: "24"
title: "Access Review and Delegation"
version: "1.0.0"
status: "official"
owner: "Clara Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "23-Permission-Scope-Model.md"
next: "25-Part-02-Summary.md"
---

# Access Review and Delegation

> *"Defines access review, role assignment review, delegation, temporary access, and access removal behavior."*
...
As teams grow, users accumulate access they no longer need. This creates security and compliance risk.
...
Clara should provide basic access visibility in MVP and evolve toward formal access review and temporary access governance.
...
|---|---|---|
| `access_review:read` | Product action permission | MVP/Future based on module |
| `access_review:run` | Product action permission | MVP/Future based on module |
| `delegation:create` | Product action permission | MVP/Future based on module |
| `temporary_access:grant` | Product action permission | MVP/Future based on module |
...
MVP should show who has access to what role in each workspace and allow owners/admins to remove access.

---

# Future Behavior

Future versions may support scheduled access reviews, temporary access expiration, approval workflows, and access certification exports.
