...
next: "27-Tenant-Model.md"
---

# Organization Workspace Overview

> *"Defines Organization and Workspace as the core tenant and collaboration boundaries inside CLARA."*
...
Without clear tenant and workspace boundaries, customer data, conversations, settings, permissions, and integrations can become mixed across teams or businesses.
...
CLARA should use Organization as the root tenant boundary and Workspace as the operational collaboration boundary.
...
MVP must support one Organization with one or more Workspaces, workspace membership, role assignment, and tenant-scoped data access.

---

# Future Behavior

Future versions may support advanced organization policies, workspace templates, cross-workspace analytics, and enterprise governance controls.
