...
previous: "26-Organization-Workspace-Overview.md"
next: "28-Organization-Lifecycle.md"
---

# Tenant Model

> *"Defines CLARA's tenant model and how Organization and Workspace scope product data and access decisions."*
...
Business teams need strong separation between different organizations and practical separation between teams or business units inside one organization.
...
CLARA should treat Organization as the legal/business tenant and Workspace as the scoped operational environment inside that tenant.
...
|---|---|---|
| `tenant:read` | Product action permission | Protected by backend authorization |
...
MVP must require organization_id on all tenant-owned records and workspace_id on workspace-owned records.

---

# Future Behavior

Future versions may support sub-organizations, regions, legal entities, and advanced data residency policies.
