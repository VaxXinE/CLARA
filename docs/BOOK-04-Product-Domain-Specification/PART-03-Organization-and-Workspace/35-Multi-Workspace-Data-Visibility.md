...
chapter: "35"
title: "Multi Workspace Data Visibility"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "34-Workspace-Switching-Navigation.md"
next: "36-Organization-Audit-Behavior.md"
---

# Multi Workspace Data Visibility

> *"Defines how data visibility works when users belong to multiple Workspaces."*
...
Managers or owners may need broad visibility, but agents should usually see only the workspace data they are assigned to.
...
CLARA should default to workspace-scoped data visibility and allow cross-workspace visibility only through explicit permissions.
...
|---|---|---|
| `workspace_data:read` | Product action permission | Protected by backend authorization |
| `workspace_data:read_cross_workspace` | Product action permission | Protected by backend authorization |
| `analytics:read_cross_workspace` | Product action permission | Protected by backend authorization |
...
MVP must keep customer, conversation, ticket, and knowledge visibility scoped by Workspace unless role explicitly grants broader view.

---

# Future Behavior

Future versions may support cross-workspace dashboards, shared customers, workspace groups, and permission-based global search.
