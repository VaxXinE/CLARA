...
chapter: "38"
title: "Organization Workspace Permissions"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "37-Workspace-Governance.md"
next: "39-MVP-Organization-Workspace-Scope.md"
---

# Organization Workspace Permissions

> *"Defines the permission catalog for Organization and Workspace product behavior."*
...
Organization-level actions have higher business risk than normal workspace actions. They need separate permissions.
...
CLARA should define separate permission groups for Organization-level and Workspace-level actions.
...
| `workspace:archive` | Product action permission | Protected by backend authorization |
...
MVP must include clear permission keys for organization settings, workspace management, membership, and role assignment.

---

# Future Behavior

Future versions may support custom permission groups, temporary elevation, approval-based changes, and enterprise policy conditions.
