...
previous: "27-Tenant-Model.md"
next: "29-Workspace-Lifecycle.md"
---

# Organization Lifecycle

> *"Defines how an Organization is created, activated, updated, suspended, archived, and eventually deleted or retained."*
...
Organizations are high-impact business objects. If lifecycle behavior is unclear, data retention, billing, access, and audit behavior become risky.
...
CLARA Organization lifecycle should be explicit and auditable because it controls business ownership, billing, data, users, and workspace access.
...
|---|---|---|
| `organization:create` | Product action permission | Protected by backend authorization |
| `organization:update` | Product action permission | Protected by backend authorization |
| `organization:suspend` | Product action permission | Protected by backend authorization |
| `organization:archive` | Product action permission | Protected by backend authorization |
...
MVP must support Organization creation, update, active status, and archive behavior with audit logging.

---

# Future Behavior

Future versions may support suspension, deletion requests, ownership transfer, retention workflows, and legal hold.
