...
previous: "30-Organization-Settings.md"
next: "32-Membership-Model.md"
---

# Workspace Settings

> *"Defines workspace-level settings that control operational behavior inside a Workspace."*
...
Different teams may need different operational behavior even inside the same organization.
...
CLARA Workspace Settings should control team-specific behavior such as inbox defaults, AI feature toggles, business hours, routing, and channel configuration.
...
MVP must support basic workspace name, description, default timezone, and AI feature toggle.

---

# Future Behavior

Future versions may support routing rules, SLA defaults, business hours, workspace-specific channels, and AI policy overrides.
