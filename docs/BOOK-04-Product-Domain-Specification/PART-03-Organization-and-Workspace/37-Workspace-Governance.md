...
previous: "36-Organization-Audit-Behavior.md"
next: "38-Organization-Workspace-Permissions.md"
---

# Workspace Governance

> *"Defines governance rules for workspace creation, configuration, ownership, and operational quality."*
...
If workspaces can be created without governance, organizations may end up with duplicate teams, unclear owners, and fragmented customer data.
...
CLARA should treat Workspaces as governed operational units with owners, settings, members, channels, and operational scope.
...
|---|---|---|
| `workspace_governance:read` | Product action permission | Protected by backend authorization |
| `workspace_governance:update` | Product action permission | Protected by backend authorization |
...
MVP should require Admin/Owner permission to create or archive a Workspace and should show owner/admin context.

---

# Future Behavior

Future versions may support workspace approval, lifecycle review, policy inheritance, and compliance governance.
