...
previous: "29-Workspace-Lifecycle.md"
next: "31-Workspace-Settings.md"
---

# Organization Settings

> *"Defines organization-level settings that apply across all Workspaces."*
...
Some settings belong to the whole business, not an individual workspace. Mixing these levels creates confusing product behavior.
...
CLARA Organization Settings should control global tenant behavior such as name, billing profile, security policy, default locale, and organization-wide governance.
...
|---|---|---|
| `organization_settings:read` | Product action permission | Protected by backend authorization |
| `organization_settings:update` | Product action permission | Protected by backend authorization |
...
MVP must support basic organization name, default locale, and organization-level administrative settings.

---

# Future Behavior

Future versions may support SSO policy, allowed domains, compliance settings, data residency, and organization branding.
