...
previous: "31-Workspace-Settings.md"
next: "33-Invitation-Onboarding.md"
---

# Membership Model

> *"Defines how users become members of Organizations and Workspaces."*
...
One user account may belong to multiple organizations or workspaces. Mixing identity and membership creates security and product confusion.
...
CLARA should separate global user identity from Organization membership and Workspace membership.
...
| `membership:remove` | Product action permission | Protected by backend authorization |
...
MVP must support inviting users to an Organization and assigning them to Workspaces with predefined roles.

---

# Future Behavior

Future versions may support team membership, temporary membership, external guest access, and access certification.
