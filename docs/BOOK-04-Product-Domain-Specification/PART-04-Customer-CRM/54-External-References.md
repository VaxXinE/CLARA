...
previous: "53-Duplicate-Customers-and-Merge.md"
next: "55-Customer-Privacy-and-Consent.md"
---

# External References

> *"Defines how CLARA links customer records to external systems and provider IDs."*
...
Customers may exist in external CRMs, chat systems, social platforms, and payment tools. Provider IDs must be tracked safely.
...
CLARA should store external references as provider-scoped identifiers rather than mixing them into core customer identity.
...
|---|---|---|
| `customer_external_ref:read` | Product action permission | Protected by backend authorization |
| `customer_external_ref:update` | Product action permission | Protected by backend authorization |
...
MVP must support provider-specific references needed for conversation channel matching.

---

# Future Behavior

Future versions may support bidirectional sync, external CRM linking, sync conflict resolution, and integration health status.
