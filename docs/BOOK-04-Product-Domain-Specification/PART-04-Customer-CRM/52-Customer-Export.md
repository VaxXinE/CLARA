...
previous: "51-Customer-Import.md"
next: "53-Duplicate-Customers-and-Merge.md"
---

# Customer Export

> *"Defines product behavior for exporting customer data."*
...
Exports can leak large amounts of customer data, so they need stronger controls than normal list viewing.
...
CLARA Customer Export should be permission-controlled, auditable, rate-limited, and privacy-aware.
...
|---|---|---|
| `customer_export:create` | Product action permission | Protected by backend authorization |
| `customer_export:download` | Product action permission | Protected by backend authorization |
...
MVP may defer bulk export or provide admin-only export for limited fields.

---

# Future Behavior

Future versions may support scheduled exports, filtered exports, compliance exports, field selection, and approval workflows.
