...
chapter: "57"
title: "Customer AI Context"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "56-Customer-Audit-Behavior.md"
next: "58-Customer-Analytics.md"
---

# Customer AI Context

> *"Defines how Customer CRM data can be used by CLARA AI features."*
...
AI-assisted replies and summaries need customer context, but AI must not access unrelated or unauthorized customer data.
...
CLARA AI should use customer context only within the actor's permission and workspace scope, and should minimize sensitive data exposure.
...
|---|---|---|
| `ai.customer_context:read` | Product action permission | Protected by backend authorization |
| `ai.summary:create` | Product action permission | Protected by backend authorization |
...
MVP may allow AI reply drafting to use customer display name, recent conversation context, and relevant knowledge within workspace scope.

---

# Future Behavior

Future versions may support AI customer summaries, risk flags, next-best-action suggestions, and privacy-aware context redaction.
