...
previous: "50-Customer-Search-and-Filtering.md"
next: "52-Customer-Export.md"
---

# Customer Import

> *"Defines product behavior for importing customer data from CSV or external systems."*
...
Businesses often have existing customer data. Importing incorrectly can create duplicates, bad records, or privacy issues.
...
CLARA Customer Import should be controlled, validated, previewed, auditable, and reversible where practical.
...
|---|---|---|
| `customer_import:create` | Product action permission | Protected by backend authorization |
| `customer_import:read` | Product action permission | Protected by backend authorization |
...
MVP may defer import, or support a simple admin-only CSV import with validation and dry-run preview.

---

# Future Behavior

Future versions may support CRM imports, mapping templates, duplicate resolution, rollback, and import audit reports.
