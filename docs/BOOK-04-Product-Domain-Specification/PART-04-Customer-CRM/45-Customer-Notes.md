...
previous: "44-Customer-Timeline.md"
next: "46-Customer-Tags-and-Labels.md"
---

# Customer Notes

> *"Defines internal notes attached to customer records."*
...
Agents and sales users need to record context, but notes can contain sensitive information and must be controlled.
...
CLARA Customer Notes should be internal, permission-controlled, auditable business context that helps teams coordinate customer interactions.
...
|---|---|---|
| `customer_note:read` | Product action permission | Protected by backend authorization |
| `customer_note:create` | Product action permission | Protected by backend authorization |
| `customer_note:update` | Product action permission | Protected by backend authorization |
| `customer_note:delete` | Product action permission | Protected by backend authorization |
...
MVP must support adding and reading customer notes with author and timestamp.

---

# Future Behavior

Future versions may support pinned notes, private notes, edit history, mentions, and AI note summarization.
