...
chapter: "49"
title: "Customer Ownership and Assignment"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "48-Customer-Lifecycle.md"
next: "50-Customer-Search-and-Filtering.md"
---

# Customer Ownership and Assignment

> *"Defines how customers may be assigned to agents, sales operators, teams, or workspaces."*
...
Teams need clarity on who is responsible for a customer, especially in sales follow-up and high-touch support.
...
CLARA should support customer ownership as optional in MVP and preserve assignment history where used.
...
|---|---|---|
| `customer_assignment:read` | Product action permission | Protected by backend authorization |
| `customer_assignment:update` | Product action permission | Protected by backend authorization |
...
MVP may support simple customer owner/assignee or defer ownership to conversation/ticket assignment.

---

# Future Behavior

Future versions may support territory assignment, account ownership, rotation rules, and assignment automation.
