...
chapter: "46"
title: "Customer Tags and Labels"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "45-Customer-Notes.md"
next: "47-Customer-Segments.md"
---

# Customer Tags and Labels

> *"Defines tags and labels used to categorize and filter customer records."*
...
Teams need flexible customer categorization without requiring complex custom fields too early.
...
CLARA should support workspace-scoped customer tags for lightweight organization, filtering, and workflow triggers.
...
|---|---|---|
| `customer_tag:read` | Product action permission | Protected by backend authorization |
| `customer_tag:create` | Product action permission | Protected by backend authorization |
| `customer_tag:update` | Product action permission | Protected by backend authorization |
...
MVP must support creating tags and assigning tags to customers.

---

# Future Behavior

Future versions may support tag governance, tag merge, tag usage analytics, and automation based on tags.
