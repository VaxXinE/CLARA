...
next: "42-Customer-Profile.md"
---

# Customer CRM Overview

> *"Defines Customer CRM as the product domain for managing customer identity, context, history, and relationship data inside CLARA."*
...
Business teams need a single customer context so they do not lose history across conversations, channels, support cases, and internal notes.
...
CLARA Customer CRM should be the customer source of operational context for conversations, tickets, sales follow-ups, AI assistance, analytics, and automation.
...
MVP must support creating, reading, updating, archiving, searching, and viewing basic customer records with workspace scope.

---

# Future Behavior

Future versions may support advanced segmentation, lifecycle automation, customer health scoring, duplicate detection, and CRM imports.
