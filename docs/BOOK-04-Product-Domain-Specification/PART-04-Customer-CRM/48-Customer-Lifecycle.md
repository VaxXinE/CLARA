...
previous: "47-Customer-Segments.md"
next: "49-Customer-Ownership-and-Assignment.md"
---

# Customer Lifecycle

> *"Defines customer lifecycle states such as lead, active customer, inactive, blocked, archived, or deleted by policy."*
...
Teams need to understand whether a customer is active, inactive, a lead, or no longer relevant without deleting important history.
...
CLARA Customer lifecycle should be simple in MVP and auditable for status changes.
...
| `customer:update_status` | Product action permission | Protected by backend authorization |
...
MVP must support active and archived statuses, with optional lifecycle stage if sales flow needs it.

---

# Future Behavior

Future versions may support lead/customer stages, churn risk, blocked state, retention policies, and lifecycle automation.
