...
previous: "46-Customer-Tags-and-Labels.md"
next: "48-Customer-Lifecycle.md"
---

# Customer Segments

> *"Defines saved customer groups based on attributes, tags, lifecycle state, behavior, or filters."*
...
Managers and operators need to find and act on groups of customers without manually filtering every time.
...
CLARA Customer Segments should start as saved filters and evolve into automation-ready dynamic groups.
...
|---|---|---|
| `customer_segment:read` | Product action permission | Protected by backend authorization |
| `customer_segment:create` | Product action permission | Protected by backend authorization |
| `customer_segment:update` | Product action permission | Protected by backend authorization |
...
MVP may support simple saved filters or defer full segmentation until after core CRM and inbox flows are stable.

---

# Future Behavior

Future versions may support dynamic segments, automation triggers, analytics segmentation, and campaign targeting.
