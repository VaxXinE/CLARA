...
chapter: "53"
title: "Duplicate Customers and Merge"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "52-Customer-Export.md"
next: "54-External-References.md"
---

# Duplicate Customers and Merge

> *"Defines how CLARA identifies and resolves duplicate customer records."*
...
Customers may appear from multiple channels. Automatic merging can corrupt history if identifiers are ambiguous.
...
CLARA should avoid automatic destructive merging in MVP and prefer safe duplicate detection with human review.
...
|---|---|---|
| `customer_duplicate:read` | Product action permission | Protected by backend authorization |
| `customer_merge:execute` | Product action permission | Protected by backend authorization |
...
MVP should prevent obvious duplicates where possible and may defer full merge workflows.

---

# Future Behavior

Future versions may support duplicate suggestions, manual merge, merge preview, undo window, and merge audit trail.
