...
chapter: "59"
title: "MVP Customer CRM Scope"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "58-Customer-Analytics.md"
next: "60-Part-04-Summary.md"
---

# MVP Customer CRM Scope

> *"Defines the MVP scope for CLARA Customer CRM."*
...
CRM can become huge quickly. MVP must focus on the minimal customer context needed to support conversations and AI-assisted workflows.
...
CLARA MVP Customer CRM should focus on secure customer identity, contact points, search, notes, tags, timeline, and basic lifecycle.
...
| `customer:archive` | Product action permission | Protected by backend authorization |
| `customer_note:create` | Product action permission | Protected by backend authorization |
| `customer_tag:assign` | Product action permission | Protected by backend authorization |
...
MVP must support customer list, customer detail, create/update/archive, contact points, notes, tags, timeline events, and search.

---

# Future Behavior

Future versions may add custom fields, duplicate merge, import/export, segmentation, advanced lifecycle, and AI customer insights.
