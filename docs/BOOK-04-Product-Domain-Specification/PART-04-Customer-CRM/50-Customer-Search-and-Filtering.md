...
previous: "49-Customer-Ownership-and-Assignment.md"
next: "51-Customer-Import.md"
---

# Customer Search and Filtering

> *"Defines how users find customers through search, filters, sorting, and list views."*
...
Users need fast customer lookup, but search can easily leak data if scope and permissions are not enforced.
...
CLARA Customer Search should be workspace-scoped, permission-filtered, paginated, and safe for sensitive fields.
...
| `customer:search` | Product action permission | Protected by backend authorization |
...
MVP must support searching customers by name and contact point with pagination and workspace scope.

---

# Future Behavior

Future versions may support advanced filters, saved views, fuzzy search, cross-workspace search, and full-text search.
