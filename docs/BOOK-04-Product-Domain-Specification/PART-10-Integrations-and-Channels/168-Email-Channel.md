...
previous: "167-Outbound-Webhooks.md"
next: "169-Web-Chat-Channel.md"
---

# Email Channel

> *"Defines product behavior for email as a customer communication channel."*
...
Email is asynchronous, threaded, attachment-heavy, and prone to spam or spoofing. Product behavior must handle it carefully.
...
CLARA Email Channel should normalize inbound and outbound email into conversations while preserving important email metadata.
...
|---|---|---|
| `email_channel:read` | Product action permission | Protected by backend authorization |
| `email_channel:connect` | Product action permission | Protected by backend authorization |
...
MVP may support email as a later channel, or use a simple inbound/outbound email adapter after inbox basics are stable.

---

# Future Behavior

Future versions may support IMAP/SMTP, Gmail/OAuth, shared inboxes, DKIM/SPF awareness, attachments, and email templates.
