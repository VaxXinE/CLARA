...
chapter: "178"
title: "Integration Audit and Observability"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "177-Integration-Security-and-Privacy.md"
next: "179-MVP-Integrations-and-Channels-Scope.md"
---

# Integration Audit and Observability

> *"Defines audit, logging, metrics, and diagnostics for integrations and channels."*
...
When integrations fail, users need to know what happened without exposing sensitive raw payloads.
...
CLARA should provide enough integration observability to answer whether a connection is healthy, failing, delayed, or misconfigured.
...
|---|---|---|
| `integration_logs:read` | Product action permission | Protected by backend authorization |
| `integration_health:read` | Product action permission | Protected by backend authorization |
...
MVP must show basic connection status and record integration audit events.

---

# Future Behavior

Future versions may support health dashboard, delivery timelines, searchable logs, redacted payload previews, and alerting.
