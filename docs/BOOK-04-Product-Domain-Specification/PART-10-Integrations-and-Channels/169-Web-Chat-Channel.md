...
previous: "168-Email-Channel.md"
next: "170-WhatsApp-Channel.md"
---

# Web Chat Channel

> *"Defines product behavior for embedded website chat."*
...
Businesses need a simple first channel they can control without complex external provider dependencies.
...
CLARA Web Chat should provide a lightweight customer messaging widget connected to workspace conversations.
...
|---|---|---|
| `web_chat:read` | Product action permission | Protected by backend authorization |
| `web_chat:configure` | Product action permission | Protected by backend authorization |
...
MVP should strongly consider web chat as the first supported channel because it is controllable and product-validating.

---

# Future Behavior

Future versions may support widget customization, visitor identity, file upload, proactive messages, and bot handoff.
