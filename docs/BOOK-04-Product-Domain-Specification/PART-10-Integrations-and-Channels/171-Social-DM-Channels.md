...
chapter: "171"
title: "Social DM Channels"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "170-WhatsApp-Channel.md"
next: "172-Custom-API-Channel.md"
---

# Social DM Channels

> *"Defines product behavior for social direct messaging channels such as Instagram DM, TikTok DM, Messenger, or similar platforms."*
...
Social DM channels are valuable but often restricted by platform policies, unstable UI behavior, rate limits, and privacy concerns.
...
CLARA Social DM Channels should be provider-policy aware and should prefer official APIs, approved integrations, or explicit user-authorized connections.
...
|---|---|---|
| `social_channel:read` | Product action permission | Protected by backend authorization |
| `social_channel:connect` | Product action permission | Protected by backend authorization |
...
MVP should document social DM requirements and avoid depending on fragile unofficial scraping for production.

---

# Future Behavior

Future versions may support official Instagram/Messenger/TikTok APIs where approved and policy-compliant.
