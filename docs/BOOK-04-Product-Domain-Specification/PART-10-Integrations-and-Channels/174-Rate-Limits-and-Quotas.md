...
previous: "173-Data-Sync-and-Mapping.md"
next: "175-Integration-Error-Handling-and-Retry.md"
---

# Rate Limits and Quotas

> *"Defines product behavior for provider rate limits, CLARA quotas, and usage restrictions."*
...
External providers impose limits. If CLARA ignores those limits, messages may fail or integrations may be blocked.
...
CLARA should make provider limits and product quotas visible enough to prevent silent failures and unexpected downtime.
...
|---|---|---|
| `integration_usage:read` | Product action permission | Protected by backend authorization |
...
MVP must handle provider rate-limit errors safely and expose basic integration failure status.

---

# Future Behavior

Future versions may support usage dashboards, quota alerts, adaptive backoff, and plan-based limits.
