...
previous: "175-Integration-Error-Handling-and-Retry.md"
next: "177-Integration-Security-and-Privacy.md"
---

# Integration Permissions and Governance

> *"Defines access control, governance, and ownership for integrations and channels."*
...
Integrations can expose large amounts of customer data or grant external systems write access. They require stronger governance than normal feature usage.
...
CLARA should restrict integration setup and credential handling to Admin/Developer roles with auditability and workspace scope.
...
| `integration:delete` | Product action permission | Protected by backend authorization |
...
MVP must restrict integration configuration to authorized Admin/Developer roles.

---

# Future Behavior

Future versions may support approval workflows, security review, installation policy, connector allowlists, and periodic access review.
