...
previous: "169-Web-Chat-Channel.md"
next: "171-Social-DM-Channels.md"
---

# WhatsApp Channel

> *"Defines product behavior for WhatsApp as a customer communication channel."*
...
WhatsApp is a high-value customer channel but has provider policies, templates, rate limits, identity constraints, and compliance requirements.
...
CLARA WhatsApp Channel should use official APIs where possible and model provider constraints explicitly.
...
|---|---|---|
| `whatsapp_channel:read` | Product action permission | Protected by backend authorization |
| `whatsapp_channel:connect` | Product action permission | Protected by backend authorization |
...
MVP may define WhatsApp integration requirements but should avoid unofficial scraping as production architecture.

---

# Future Behavior

Future versions may support WhatsApp Cloud API, template management, opt-in tracking, delivery receipts, and provider diagnostics.
