...
chapter: "183"
title: "Billing Account Model"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "182-Admin-Console-Model.md"
next: "184-Plan-and-Pricing-Model.md"
---

# Billing Account Model

> *"Defines the Billing Account object and its relationship to Organization ownership."*
...
Billing ownership must be clear because billing changes affect access, subscription status, invoices, and product limits.
...
CLARA Billing Account should be tied to an Organization and managed by Owner/Billing Admin roles.
...
| `billing_profile:update` | Product action permission | Protected by backend authorization |
...
MVP may display billing status and plan metadata without real payment processing if product is pre-commercial.

---

# Future Behavior

Future versions may support billing profile, payment method, tax metadata, invoice delivery, and provider integrations.
