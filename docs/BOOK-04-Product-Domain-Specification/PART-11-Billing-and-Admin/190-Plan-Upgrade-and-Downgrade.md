...
previous: "189-Invoices-and-Payment-Records.md"
next: "191-Admin-Organization-Settings.md"
---

# Plan Upgrade and Downgrade

> *"Defines product behavior for changing plans."*
...
Changing plans can disable features or affect limits. Users need clarity before confirming.
...
CLARA plan changes should show capability impact, limit impact, billing impact, and effective date before confirmation.
...
|---|---|---|
| `plan:update` | Product action permission | Protected by backend authorization |
...
MVP may defer self-service plan changes and handle plan updates manually or internally.

---

# Future Behavior

Future versions may support self-service upgrades, downgrade preview, proration, scheduled changes, and approval workflows.
