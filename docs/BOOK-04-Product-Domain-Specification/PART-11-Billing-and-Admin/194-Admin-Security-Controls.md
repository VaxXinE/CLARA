...
previous: "193-Feature-Flags-and-Rollouts.md"
next: "195-Admin-AI-Controls.md"
---

# Admin Security Controls

> *"Defines security settings exposed through Admin Console."*
...
Security controls are needed, but confusing settings can cause accidental lockout or weak configurations.
...
CLARA Admin Security Controls should expose only understandable, safe, high-impact settings that improve organization security posture.
...
|---|---|---|
| `security_settings:read` | Product action permission | Protected by backend authorization |
| `security_settings:update` | Product action permission | Protected by backend authorization |
...
MVP may include basic security settings documentation and defer advanced configurable controls.

---

# Future Behavior

Future versions may support SSO, MFA enforcement, allowed domains, session timeout, IP allowlist, API key policy, and retention controls.
