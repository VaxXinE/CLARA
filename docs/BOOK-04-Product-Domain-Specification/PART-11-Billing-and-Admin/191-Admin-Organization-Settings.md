...
previous: "190-Plan-Upgrade-and-Downgrade.md"
next: "192-Admin-Workspace-Settings.md"
---

# Admin Organization Settings

> *"Defines organization-wide settings managed from Admin Console."*
...
Organization-level settings affect all workspaces and users. They require strong permission and audit behavior.
...
CLARA Organization Settings should cover tenant identity, default locale/timezone, security defaults, billing references, and governance controls.
...
MVP must support organization name, locale/timezone basics, and safe owner/admin-only updates.

---

# Future Behavior

Future versions may support domain policies, data retention settings, SSO, audit policies, and enterprise governance.
