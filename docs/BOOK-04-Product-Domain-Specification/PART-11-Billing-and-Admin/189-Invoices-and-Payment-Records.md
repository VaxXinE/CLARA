...
previous: "188-Seats-and-Members-Billing.md"
next: "190-Plan-Upgrade-and-Downgrade.md"
---

# Invoices and Payment Records

> *"Defines product behavior for invoices, receipts, payment status, and billing history."*
...
Billing records contain financial and business-sensitive information. Access must be restricted and auditable.
...
CLARA Invoices should be visible only to authorized billing roles and should be treated as sensitive business records.
...
|---|---|---|
| `invoice:read` | Product action permission | Protected by backend authorization |
| `invoice:download` | Product action permission | Protected by backend authorization |
...
MVP may defer invoice UI if payment processing is not enabled.

---

# Future Behavior

Future versions may support invoice list, invoice download, payment status, tax invoices, and billing contact notifications.
