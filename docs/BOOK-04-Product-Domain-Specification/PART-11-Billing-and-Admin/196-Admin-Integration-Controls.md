...
chapter: "196"
title: "Admin Integration Controls"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "195-Admin-AI-Controls.md"
next: "197-Admin-Audit-and-Billing-Events.md"
---

# Admin Integration Controls

> *"Defines admin controls for integrations, connectors, channels, and developer access."*
...
Integrations affect external data flow and business risk. Admins need visibility and control.
...
CLARA Admin Integration Controls should centralize connection status, installation permissions, credential metadata, and disconnect actions.
...
| `api_key:manage` | Product action permission | Protected by backend authorization |
...
MVP must show connected integrations/channels and allow authorized disconnect or configuration updates.

---

# Future Behavior

Future versions may support integration approval, connector allowlists, API key policy, webhook management, and health dashboards.
