...
previous: "192-Admin-Workspace-Settings.md"
next: "194-Admin-Security-Controls.md"
---

# Feature Flags and Rollouts

> *"Defines product behavior for controlled feature release and module availability."*
...
New features need controlled exposure. Without flags, releases become riskier and harder to reverse.
...
CLARA should use feature flags for controlled rollout, internal testing, plan entitlements, and safe progressive delivery.
...
|---|---|---|
| `feature_flag:read` | Product action permission | Protected by backend authorization |
| `feature_flag:update` | Product action permission | Protected by backend authorization |
...
MVP may use internal feature flags for major modules such as AI, automation, integrations, and billing.

---

# Future Behavior

Future versions may support admin-visible beta flags, tenant allowlists, percentage rollouts, and experiment management.
