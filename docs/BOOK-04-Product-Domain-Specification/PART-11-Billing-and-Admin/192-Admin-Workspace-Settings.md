...
previous: "191-Admin-Organization-Settings.md"
next: "193-Feature-Flags-and-Rollouts.md"
---

# Admin Workspace Settings

> *"Defines workspace-level admin settings accessible through Admin Console."*
...
Workspace behavior needs local configuration without mixing it with organization-wide settings.
...
CLARA Workspace Admin Settings should manage workspace identity, operational defaults, AI toggles, channel configuration links, and feature availability.
...
|---|---|---|
| `workspace_settings:read` | Product action permission | Protected by backend authorization |
| `workspace_settings:update` | Product action permission | Protected by backend authorization |
...
MVP must support workspace name, timezone, description, and basic feature toggles where relevant.

---

# Future Behavior

Future versions may support business hours, routing defaults, SLA settings, AI policy overrides, and workspace templates.
