...
previous: "186-Entitlement-System.md"
next: "188-Seats-and-Members-Billing.md"
---

# Usage Limits and Quotas

> *"Defines usage counting, limits, quotas, and plan-based restrictions."*
...
Without clear limits, organizations may overuse expensive resources such as AI calls, integrations, storage, messages, and seats.
...
CLARA Usage Limits should be visible, enforceable, and consistent across modules that consume plan resources.
...
|---|---|---|
| `usage:read` | Product action permission | Protected by backend authorization |
| `quota:read` | Product action permission | Protected by backend authorization |
| `quota:update` | Product action permission | Protected by backend authorization |
...
MVP should define usage counters for seats, workspaces, AI requests, messages, and storage even if not all limits are enforced yet.

---

# Future Behavior

Future versions may support usage-based billing, overage pricing, quota alerts, soft/hard limits, and usage forecasting.
