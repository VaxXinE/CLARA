...
previous: "194-Admin-Security-Controls.md"
next: "196-Admin-Integration-Controls.md"
---

# Admin AI Controls

> *"Defines admin-level controls for AI features."*
...
AI features affect privacy, customer communication, and operational trust. Admins need control over where AI is allowed.
...
CLARA Admin AI Controls should allow authorized admins to enable, disable, and govern AI features at organization or workspace scope.
...
|---|---|---|
| `ai_settings:read` | Product action permission | Protected by backend authorization |
| `ai_settings:update` | Product action permission | Protected by backend authorization |
| `ai.analytics:read` | Product action permission | Protected by backend authorization |
...
MVP must support basic AI enable/disable control if AI features are included.

---

# Future Behavior

Future versions may support model policy, AI data retention policy, per-feature toggles, approval rules, and AI usage limits.
