...
previous: "184-Plan-and-Pricing-Model.md"
next: "186-Entitlement-System.md"
---

# Subscription Lifecycle

> *"Defines how subscriptions are created, activated, renewed, changed, suspended, cancelled, and expired."*
...
If subscription states are unclear, organizations may lose access unexpectedly or keep access after cancellation.
...
CLARA Subscription Lifecycle should be explicit because subscription state controls product access and entitlements.
...
|---|---|---|
| `subscription:read` | Product action permission | Protected by backend authorization |
| `subscription:update` | Product action permission | Protected by backend authorization |
...
MVP must support active plan/subscription state for entitlement checks even if payment processing is deferred.

---

# Future Behavior

Future versions may support trials, renewals, cancellation flow, grace periods, dunning, and subscription history.
