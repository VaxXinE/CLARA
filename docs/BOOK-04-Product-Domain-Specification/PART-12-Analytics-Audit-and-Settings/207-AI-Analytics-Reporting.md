...
previous: "206-Inbox-and-Support-Analytics.md"
next: "208-Workflow-and-Integration-Analytics.md"
---

# AI Analytics Reporting

> *"Defines analytics for AI usage, quality, adoption, safety, and business impact."*
...
AI can look impressive while producing low-quality or risky output. Teams need quality and safety metrics, not only usage counts.
...
CLARA AI Analytics should measure AI usefulness, review outcomes, safety blocks, adoption, and operational impact without overclaiming value.
...
MVP may track AI draft requests, accepted drafts, rejected drafts, edits, and feedback.

---

# Future Behavior

Future versions may support model comparison, safety dashboards, evaluation trend, ROI reports, and RAG quality metrics.
