...
previous: "213-Settings-Architecture-Product-Behavior.md"
next: "215-Notification-Settings.md"
---

# User Preferences

> *"Defines user-level settings and preferences."*
...
Users need control over personal defaults, but user preferences must not affect security or shared business behavior.
...
CLARA User Preferences should allow users to configure personal experience without changing organization or workspace behavior.
...
|---|---|---|
| `user_preference:read` | Product action permission | Protected by backend authorization |
| `user_preference:update` | Product action permission | Protected by backend authorization |
...
MVP may support default workspace, timezone, language, and basic notification preferences.

---

# Future Behavior

Future versions may support theme, layout preferences, dashboard preferences, saved views, and AI tone preferences.
