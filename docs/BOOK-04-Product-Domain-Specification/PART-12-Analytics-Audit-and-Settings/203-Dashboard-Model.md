...
previous: "202-Analytics-Product-Model.md"
next: "204-Operational-Metrics.md"
---

# Dashboard Model

> *"Defines dashboard behavior, layout, widgets, filters, and dashboard visibility."*
...
Users need a quick understanding of business operations without manually checking every module.
...
CLARA Dashboard should present operational summaries through permission-scoped widgets and predefined views.
...
|---|---|---|
| `dashboard:read` | Product action permission | Protected by backend authorization |
| `dashboard:update` | Product action permission | Protected by backend authorization |
...
MVP should provide predefined dashboards such as overview, inbox, tickets, customers, and AI usage where available.

---

# Future Behavior

Future versions may support custom widgets, saved dashboard layouts, embedded reports, and role-specific dashboards.
