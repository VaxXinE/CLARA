...
chapter: "217"
title: "Reporting Permissions and Visibility"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "216-Data-Export-and-Retention-Settings.md"
next: "218-Analytics-Privacy-and-Data-Minimization.md"
---

# Reporting Permissions and Visibility

> *"Defines who can view analytics, dashboards, reports, audit logs, and exports."*
...
Reports can reveal sensitive operational, customer, team, or financial information. Visibility must be controlled.
...
CLARA Reporting Permissions should enforce scope and role-based visibility for analytics and audit data.
...
|---|---|---|
| `report:read` | Product action permission | Protected by backend authorization |
| `report_export:create` | Product action permission | Protected by backend authorization |
...
MVP must enforce analytics and audit permissions separately from normal product usage permissions.

---

# Future Behavior

Future versions may support report sharing, dashboard-level permissions, row-level security, and scheduled report recipients.
