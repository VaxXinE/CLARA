...
chapter: "212"
title: "Audit Export and Compliance Evidence"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "211-Audit-Search-and-Filtering.md"
next: "213-Settings-Architecture-Product-Behavior.md"
---

# Audit Export and Compliance Evidence

> *"Defines audit export, evidence packaging, and compliance support behavior."*
...
Audit exports can expose sensitive activity data, but organizations may need evidence for compliance, investigation, or customer requests.
...
CLARA Audit Export should be permission-controlled, auditable, scoped, and privacy-aware.
...
|---|---|---|
| `audit_export:create` | Product action permission | Protected by backend authorization |
| `audit_export:download` | Product action permission | Protected by backend authorization |
| `compliance_evidence:read` | Product action permission | Protected by backend authorization |
...
MVP may defer export but should design audit data so export is possible later.

---

# Future Behavior

Future versions may support CSV/JSON export, signed evidence packages, scheduled compliance reports, and retention-policy-aware exports.
