...
chapter: "206"
title: "Inbox and Support Analytics"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "205-Customer-Analytics-Reporting.md"
next: "207-AI-Analytics-Reporting.md"
---

# Inbox and Support Analytics

> *"Defines analytics for Conversations, Inbox, Ticketing, and support operations."*
...
Support teams need visibility into workload and service quality to improve operations.
...
CLARA Inbox and Support Analytics should help managers understand volume, backlog, response quality, resolution speed, and team workload.
...
|---|---|---|
| `inbox_analytics:read` | Product action permission | Protected by backend authorization |
| `ticket_analytics:read` | Product action permission | Protected by backend authorization |
...
MVP must include simple counts for open/resolved conversations and tickets.

---

# Future Behavior

Future versions may support SLA analytics, channel trends, agent performance, escalation trends, and quality review metrics.
