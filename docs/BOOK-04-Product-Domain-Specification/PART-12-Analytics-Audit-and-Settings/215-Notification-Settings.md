...
previous: "214-User-Preferences.md"
next: "216-Data-Export-and-Retention-Settings.md"
---

# Notification Settings

> *"Defines notification preference behavior for users, workspaces, and admin events."*
...
Too many notifications cause fatigue; too few notifications cause missed work and security blind spots.
...
CLARA Notification Settings should help users control noise while preserving critical operational and security alerts.
...
|---|---|---|
| `notification_preference:read` | Product action permission | Protected by backend authorization |
...
MVP may support basic in-app notification preferences and unread indicators.

---

# Future Behavior

Future versions may support email/push/slack notifications, digest schedules, routing rules, and critical alert policies.
