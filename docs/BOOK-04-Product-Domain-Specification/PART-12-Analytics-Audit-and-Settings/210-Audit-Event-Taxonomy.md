...
chapter: "210"
title: "Audit Event Taxonomy"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "209-Audit-Log-Product-Model.md"
next: "211-Audit-Search-and-Filtering.md"
---

# Audit Event Taxonomy

> *"Defines the taxonomy of auditable events across CLARA modules."*
...
Inconsistent audit event names make investigation, compliance, and debugging harder.
...
CLARA should define stable audit event names grouped by product domain and risk level.
...
|---|---|---|
| `audit_taxonomy:read` | Product action permission | Protected by backend authorization |
...
MVP must define audit categories for auth/access, admin, customer, conversation, ticket, knowledge, AI, workflow, integration, and billing.

---

# Future Behavior

Future versions may support compliance mapping, event severity, event retention class, and policy-based audit rules.
