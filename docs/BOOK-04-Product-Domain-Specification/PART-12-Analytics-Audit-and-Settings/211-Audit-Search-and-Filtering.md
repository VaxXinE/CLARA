...
chapter: "211"
title: "Audit Search and Filtering"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "210-Audit-Event-Taxonomy.md"
next: "212-Audit-Export-and-Compliance-Evidence.md"
---

# Audit Search and Filtering

> *"Defines how admins and security reviewers search and filter audit events."*
...
Audit logs are only useful if authorized users can find relevant events quickly without exposing sensitive payloads.
...
CLARA Audit Search should support safe, scoped search by actor, action, resource, module, workspace, time range, and outcome.
...
| `audit:search` | Product action permission | Protected by backend authorization |
...
MVP must support time-range filtering and module/action filtering for audit events.

---

# Future Behavior

Future versions may support full-text metadata search, saved audit queries, anomaly filters, and compliance-specific views.
