...
previous: "07-MVP-Scope.md"
next: "09-Product-Risks.md"
---

# Non Goals

> *"Defines what Clara should intentionally not build in early product phases."*
...
Non-goals protect the team from scope creep and keep MVP delivery focused.
...
Clara should explicitly avoid early over-expansion into full ERP, accounting, HRIS, advanced marketplace, enterprise compliance automation, and unrestricted autonomous agents.
...
- Deferred features are not hidden inside MVP
- Backlog remains focused
- Architecture does not overfit future assumptions
