...
previous: "03-Product-Scope.md"
next: "05-Core-Use-Cases.md"
---

# Target Users

> *"Defines Clara's primary, secondary, and administrative user groups."*
...
If target users are unclear, Clara may over-optimize for power users, under-serve daily operators, or build admin-heavy features too early.
...
Clara should initially target small-to-medium business teams that handle customer conversations, support workflows, knowledge, and operational coordination.
...
- Core flows match target users
- MVP serves daily operators
- Admin features support governance without blocking simple usage
