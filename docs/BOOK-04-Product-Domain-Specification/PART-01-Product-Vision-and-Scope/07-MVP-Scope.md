...
previous: "06-Product-Principles.md"
next: "08-Non-Goals.md"
---

# MVP Scope

> *"Defines the minimum production-grade Clara product slice required for the first usable release."*
...
An MVP that is too wide becomes fragile. An MVP that is too shallow cannot prove Clara's value.
...
Clara MVP should be a narrow but production-grade vertical slice covering organization, workspace, user access, customer CRM, conversation inbox, knowledge base, AI reply drafting, audit basics, and settings basics.
...
- MVP delivers end-to-end value
- MVP has security baseline
- MVP has production readiness checklist
