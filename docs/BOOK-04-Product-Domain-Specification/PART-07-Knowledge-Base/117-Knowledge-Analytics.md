...
previous: "116-Knowledge-Audit-Behavior.md"
next: "118-Knowledge-Security-and-Privacy.md"
---

# Knowledge Analytics

> *"Defines analytics derived from knowledge usage, search, feedback, and AI retrieval."*
...
Teams need to know which articles help, which are stale, and where knowledge is missing.
...
CLARA Knowledge Analytics should help teams understand content usage, gaps, quality, and AI grounding effectiveness.
...
|---|---|---|
| `knowledge_analytics:read` | Product action permission | Protected by backend authorization |
...
MVP may show basic article counts and recently updated articles.

---

# Future Behavior

Future versions may support search analytics, article usefulness, AI retrieval analytics, content gaps, and stale content reports.
