...
previous: "107-Knowledge-Visibility.md"
next: "109-Knowledge-and-RAG-Grounding.md"
---

# Knowledge Search

> *"Defines how users and AI systems search knowledge content."*
...
Knowledge is only valuable when users and AI can find the right answer quickly.
...
CLARA Knowledge Search should be permission-scoped, workspace-aware, and optimized for fast retrieval of trusted content.
...
MVP must support keyword search over published internal articles within workspace scope.

---

# Future Behavior

Future versions may support semantic search, hybrid search, synonyms, suggested articles, and AI answer retrieval.
