...
chapter: "103"
title: "Collections and Categories"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "102-Knowledge-Article-Model.md"
next: "104-Article-Authoring-Experience.md"
---

# Collections and Categories

> *"Defines how knowledge articles are organized into collections, categories, and navigation groups."*
...
A flat list of articles becomes hard to navigate as knowledge grows.
...
CLARA should use collections and categories to organize knowledge by topic, product area, team, or customer workflow.
...
|---|---|---|
| `knowledge_collection:read` | Product action permission | Protected by backend authorization |
| `knowledge_collection:create` | Product action permission | Protected by backend authorization |
| `knowledge_collection:update` | Product action permission | Protected by backend authorization |
...
MVP may support simple collections or categories with article assignment.

---

# Future Behavior

Future versions may support nested categories, public navigation, role-based collections, and collection analytics.
