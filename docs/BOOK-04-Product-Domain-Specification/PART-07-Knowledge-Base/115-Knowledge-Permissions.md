...
chapter: "115"
title: "Knowledge Permissions"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "114-Public-Help-Center.md"
next: "116-Knowledge-Audit-Behavior.md"
---

# Knowledge Permissions

> *"Defines permission behavior for viewing, creating, editing, publishing, archiving, and using knowledge in AI context."*
...
Not every user who can read knowledge should be allowed to publish or expose it to AI/customer-facing flows.
...
CLARA Knowledge permissions should separate reading, authoring, publishing, visibility control, and AI grounding usage.
...
| `knowledge:publish` | Product action permission | Protected by backend authorization |
| `knowledge:archive` | Product action permission | Protected by backend authorization |
| `ai.knowledge_context:read` | Product action permission | Protected by backend authorization |
...
MVP must distinguish read access from create/update/publish permissions.

---

# Future Behavior

Future versions may support collection-level permissions, approval workflows, and public publishing permissions.
