...
previous: "104-Article-Authoring-Experience.md"
next: "106-Article-Versioning.md"
---

# Article Lifecycle

> *"Defines article states such as draft, review, published, archived, and deprecated."*
...
If draft or outdated content is used as trusted knowledge, agents and AI may give wrong answers.
...
CLARA Article Lifecycle should make article readiness explicit and prevent unreviewed drafts from being treated as trusted knowledge.
...
|---|---|---|
| `knowledge:update_status` | Product action permission | Protected by backend authorization |
...
MVP must support draft, published, and archived states.

---

# Future Behavior

Future versions may support review workflow, approval gates, deprecation notices, and scheduled publishing.
