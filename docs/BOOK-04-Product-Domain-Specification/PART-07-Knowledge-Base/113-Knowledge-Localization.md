...
previous: "112-Knowledge-Templates.md"
next: "114-Public-Help-Center.md"
---

# Knowledge Localization

> *"Defines multilingual and locale-specific knowledge behavior."*
...
Businesses may support customers in multiple languages, and AI responses need language-aware knowledge.
...
CLARA should design knowledge content so localization can be added later without rewriting the domain model.
...
|---|---|---|
| `knowledge_translation:read` | Product action permission | Protected by backend authorization |
| `knowledge_translation:create` | Product action permission | Protected by backend authorization |
| `knowledge_translation:update` | Product action permission | Protected by backend authorization |
...
MVP can be single-language, but article model should not block future localization.

---

# Future Behavior

Future versions may support translations, locale fallback, AI-assisted translation, and locale-specific publishing.
