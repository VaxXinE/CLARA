...
previous: "110-Knowledge-Quality-Review.md"
next: "112-Knowledge-Templates.md"
---

# Knowledge Feedback

> *"Defines how users provide feedback on article usefulness, accuracy, and missing content."*
...
Knowledge Managers need signals from agents and customers to know what content is useful or broken.
...
CLARA should collect lightweight feedback so knowledge quality can improve based on real usage.
...
|---|---|---|
| `knowledge_feedback:create` | Product action permission | Protected by backend authorization |
| `knowledge_feedback:read` | Product action permission | Protected by backend authorization |
| `knowledge_feedback:update` | Product action permission | Protected by backend authorization |
...
MVP may defer feedback or support simple internal article feedback.

---

# Future Behavior

Future versions may support helpful/unhelpful votes, correction suggestions, customer feedback, and feedback queues.
