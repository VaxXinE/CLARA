...
previous: "111-Knowledge-Feedback.md"
next: "113-Knowledge-Localization.md"
---

# Knowledge Templates

> *"Defines article templates for consistent knowledge creation."*
...
Without templates, knowledge quality varies widely and articles become harder to scan.
...
CLARA should eventually support templates for common article types such as FAQ, troubleshooting, policy, and how-to guides.
...
|---|---|---|
| `knowledge_template:read` | Product action permission | Protected by backend authorization |
| `knowledge_template:create` | Product action permission | Protected by backend authorization |
| `knowledge_template:update` | Product action permission | Protected by backend authorization |
...
MVP may use documentation guidance instead of in-app templates.

---

# Future Behavior

Future versions may support reusable article templates, required sections, and AI-assisted template generation.
