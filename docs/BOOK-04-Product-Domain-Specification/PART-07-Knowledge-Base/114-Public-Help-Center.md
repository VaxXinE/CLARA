...
previous: "113-Knowledge-Localization.md"
next: "115-Knowledge-Permissions.md"
---

# Public Help Center

> *"Defines future public help center behavior powered by Knowledge Base."*
...
Customer-facing knowledge needs stronger quality, branding, navigation, and exposure controls than internal articles.
...
CLARA should treat public help center as a separate visibility and publishing layer on top of Knowledge Base.
...
|---|---|---|
| `knowledge_public:read` | Product action permission | Protected by backend authorization |
| `knowledge_public:publish` | Product action permission | Protected by backend authorization |
| `help_center:update` | Product action permission | Protected by backend authorization |
...
MVP may defer public help center and focus on internal knowledge used by agents and AI.

---

# Future Behavior

Future versions may support public help center, custom domain, SEO metadata, public search, and customer feedback.
