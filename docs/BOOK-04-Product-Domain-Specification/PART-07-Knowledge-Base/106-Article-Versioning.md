...
previous: "105-Article-Lifecycle.md"
next: "107-Knowledge-Visibility.md"
---

# Article Versioning

> *"Defines how CLARA tracks article revisions and preserves knowledge history."*
...
Knowledge changes can affect customer support quality and AI output. Teams need to know what changed and when.
...
CLARA should preserve article version history for published knowledge and sensitive knowledge changes.
...
|---|---|---|
| `knowledge_version:read` | Product action permission | Protected by backend authorization |
| `knowledge_version:restore` | Product action permission | Protected by backend authorization |
...
MVP may keep basic updated_at/author metadata and can defer full version restore if delivery speed matters.

---

# Future Behavior

Future versions may support full version history, diff view, restore, approval per version, and published version locks.
