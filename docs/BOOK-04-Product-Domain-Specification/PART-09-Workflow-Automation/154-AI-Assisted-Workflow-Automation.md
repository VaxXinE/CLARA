...
previous: "153-Automation-for-Customers-and-CRM.md"
next: "155-Workflow-Permissions-and-Risk-Levels.md"
---

# AI Assisted Workflow Automation

> *"Defines how AI can assist with workflow automation without becoming unsafe autonomous execution."*
...
AI can make automation easier, but AI-generated automation may be wrong, overbroad, or unsafe.
...
CLARA AI should assist workflow automation by suggesting rules, explaining workflows, classifying events, or drafting actions while requiring approval for risky execution.
...
|---|---|---|
| `ai.workflow_suggestion:create` | Product action permission | Protected by backend authorization |
...
MVP should not allow AI to create active workflows automatically.

---

# Future Behavior

Future versions may support AI-generated workflow drafts, natural-language workflow builder, and AI-based classification triggers with evaluation.
