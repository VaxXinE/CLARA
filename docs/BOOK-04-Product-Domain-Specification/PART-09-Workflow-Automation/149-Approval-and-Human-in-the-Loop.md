...
chapter: "149"
title: "Approval and Human in the Loop"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "148-Workflow-Execution.md"
next: "150-Workflow-Templates.md"
---

# Approval and Human in the Loop

> *"Defines when workflow actions require human approval before execution."*
...
Automation can move fast, but high-risk actions need human accountability.
...
CLARA should require approval for high-risk workflow actions such as customer-visible communication, bulk data changes, exports, and destructive operations.
...
|---|---|---|
| `workflow_approval:read` | Product action permission | Protected by backend authorization |
| `workflow_approval:approve` | Product action permission | Protected by backend authorization |
| `workflow_approval:reject` | Product action permission | Protected by backend authorization |
...
MVP may avoid high-risk actions that require approval or require manual confirmation before execution.

---

# Future Behavior

Future versions may support approval queues, role-based approvals, risk-based routing, and approval expiration.
