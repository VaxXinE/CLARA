...
previous: "149-Approval-and-Human-in-the-Loop.md"
next: "151-Automation-for-Conversations.md"
---

# Workflow Templates

> *"Defines reusable workflow templates for common business automation patterns."*
...
Users may not know how to design good automation rules. Templates reduce friction and improve safety.
...
CLARA should eventually provide workflow templates so users can adopt automation safely without building from scratch.
...
|---|---|---|
| `workflow_template:read` | Product action permission | Protected by backend authorization |
| `workflow_template:apply` | Product action permission | Protected by backend authorization |
...
MVP may include hardcoded/predefined simple automations instead of a full template system.

---

# Future Behavior

Future versions may support template marketplace, organization templates, recommended templates, and AI-generated templates.
