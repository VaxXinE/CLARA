...
chapter: "146"
title: "Workflow Builder Experience"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "145-Action-Model.md"
next: "147-Workflow-Lifecycle.md"
---

# Workflow Builder Experience

> *"Defines the user experience for creating and editing workflows."*
...
Non-technical users need automation power without accidentally creating destructive or confusing workflows.
...
CLARA Workflow Builder should prioritize clarity, previews, safe defaults, validation, and explainable automation behavior.
...
| `workflow:test` | Product action permission | Protected by backend authorization |
...
MVP may defer visual workflow builder and instead provide predefined automation settings.

---

# Future Behavior

Future versions may support drag-and-drop builder, step previews, dry-runs, templates, and AI-assisted workflow creation.
