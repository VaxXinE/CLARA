...
previous: "144-Condition-Model.md"
next: "146-Workflow-Builder-Experience.md"
---

# Action Model

> *"Defines workflow actions that can be executed after triggers and conditions pass."*
...
Actions can change business state or communicate externally. Unsafe actions create operational and security risk.
...
CLARA actions should be explicit, permission-checked, scoped, auditable operations that affect CLARA resources or external integrations.
...
|---|---|---|
| `workflow_action:read` | Product action permission | Protected by backend authorization |
| `workflow_action:update` | Product action permission | Protected by backend authorization |
...
MVP may support low-risk actions such as add tag, assign conversation, create ticket, notify user, or set priority.

---

# Future Behavior

Future versions may support external webhook calls, email sends, CRM updates, AI-generated actions, and multi-system orchestration.
