...
previous: "143-Trigger-Model.md"
next: "145-Action-Model.md"
---

# Condition Model

> *"Defines workflow conditions used to decide whether actions should run."*
...
Conditions decide whether automation acts. Complex or hidden conditions make workflows hard to trust.
...
CLARA conditions should be simple, deterministic, auditable checks against allowed fields in scoped product objects.
...
|---|---|---|
| `workflow_condition:read` | Product action permission | Protected by backend authorization |
| `workflow_condition:update` | Product action permission | Protected by backend authorization |
...
MVP may support basic conditions like channel equals, status equals, priority equals, tag exists, assignee is empty, or customer field matches.

---

# Future Behavior

Future versions may support condition groups, nested logic, time windows, customer segments, SLA state, and AI classification results.
