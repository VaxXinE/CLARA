...
previous: "157-Workflow-Error-Handling-and-Retry.md"
next: "159-MVP-Workflow-Automation-Scope.md"
---

# Workflow Analytics

> *"Defines analytics for workflow usage, success, failure, and operational impact."*
...
Users need confidence that automation is working and not silently failing.
...
CLARA Workflow Analytics should show whether automation is running correctly and helping operations.
...
MVP may show basic execution counts and recent failures.

---

# Future Behavior

Future versions may support automation impact reports, bottleneck analysis, failure trends, and ROI dashboards.
