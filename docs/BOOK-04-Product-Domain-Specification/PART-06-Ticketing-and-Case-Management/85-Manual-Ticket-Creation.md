...
previous: "84-Ticket-Creation-from-Conversation.md"
next: "86-Ticket-Assignment-and-Ownership.md"
---

# Manual Ticket Creation

> *"Defines how users create tickets manually without starting from a conversation."*
...
Not every customer issue starts from a conversation. Teams may need to create cases from calls, meetings, internal discoveries, or imported context.
...
CLARA should support manual ticket creation for issues discovered outside the inbox.
...
MVP must support manual ticket creation linked to a customer and workspace.

---

# Future Behavior

Future versions may support templates, custom fields, required fields by ticket type, and intake forms.
