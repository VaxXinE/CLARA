...
chapter: "93"
title: "Related Tickets and Linking"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "92-Ticket-Escalation.md"
next: "94-Ticket-Notes-and-Activity.md"
---

# Related Tickets and Linking

> *"Defines how tickets relate to other tickets, conversations, customers, and knowledge articles."*
...
Issues may be connected across customers, conversations, or known problems. Users need context without creating confusing duplicates.
...
CLARA should allow tickets to link to relevant product objects while preserving clear ownership and permissions.
...
|---|---|---|
| `ticket_link:read` | Product action permission | Protected by backend authorization |
| `ticket_link:create` | Product action permission | Protected by backend authorization |
| `ticket_link:delete` | Product action permission | Protected by backend authorization |
...
MVP must support linking ticket to customer and source conversation.

---

# Future Behavior

Future versions may support duplicate links, parent-child tickets, knowledge links, problem/incident grouping, and dependency tracking.
