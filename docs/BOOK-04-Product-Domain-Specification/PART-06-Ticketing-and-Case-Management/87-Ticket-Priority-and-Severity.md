...
chapter: "87"
title: "Ticket Priority and Severity"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "86-Ticket-Assignment-and-Ownership.md"
next: "88-Ticket-SLA-Policy.md"
---

# Ticket Priority and Severity

> *"Defines product behavior for ticket priority and severity."*
...
Teams need to know what should be handled first, but priority and severity are often mixed.
...
CLARA should separate business priority from technical/customer-impact severity when the product becomes mature enough.
...
|---|---|---|
| `ticket_priority:read` | Product action permission | Protected by backend authorization |
| `ticket_priority:update` | Product action permission | Protected by backend authorization |
...
MVP must support simple priority such as low, normal, high, urgent.

---

# Future Behavior

Future versions may support severity, impact/urgency matrix, priority automation, and priority-based SLA.
