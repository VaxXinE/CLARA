...
previous: "91-Customer-Visible-Ticket-Behavior.md"
next: "93-Related-Tickets-and-Linking.md"
---

# Ticket Escalation

> *"Defines how tickets are escalated to managers, specialists, or higher support levels."*
...
Some issues need higher attention. Without escalation, urgent issues can remain stuck with the wrong owner.
...
CLARA Ticket Escalation should be explicit, auditable, and tied to priority, SLA risk, or manual judgment.
...
|---|---|---|
| `ticket:escalate` | Product action permission | Protected by backend authorization |
| `ticket_escalation:read` | Product action permission | Protected by backend authorization |
...
MVP may support manual escalation using priority change or assignment to manager.

---

# Future Behavior

Future versions may support escalation levels, automatic escalation, SLA-triggered escalation, and escalation notifications.
