...
chapter: "81"
title: "Ticketing Case Management Overview"
version: "1.0.0"
status: "official"
...
next: "82-Ticket-Model.md"
---

# Ticketing Case Management Overview

> *"Defines Ticketing and Case Management as CLARA's product domain for tracking customer issues from intake to resolution."*
...
Conversations capture communication, but not every customer issue can be resolved inside a single thread. Teams need durable cases to track work until resolution.
...
CLARA Ticketing should model customer issues as structured cases with ownership, status, priority, SLA visibility, collaboration, and auditability.
...
| `ticket:update` | Product action permission | Protected by backend authorization |
...
MVP must support ticket list, ticket detail, creation, assignment, status update, priority, link to customer, and link to conversation.

---

# Future Behavior

Future versions may support advanced SLA, case hierarchy, escalation automation, customer portal visibility, and approval workflows.
