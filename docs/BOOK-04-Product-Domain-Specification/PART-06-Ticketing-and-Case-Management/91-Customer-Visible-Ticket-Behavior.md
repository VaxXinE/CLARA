...
chapter: "91"
title: "Customer Visible Ticket Behavior"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "90-Ticket-Collaboration.md"
next: "92-Ticket-Escalation.md"
---

# Customer Visible Ticket Behavior

> *"Defines what ticket information may be visible to customers."*
...
Showing internal ticket data to customers too early can expose sensitive notes, incorrect status, or internal process details.
...
CLARA MVP should treat tickets as internal by default and only expose customer-visible status after explicit product support exists.
...
|---|---|---|
| `ticket_public:read` | Product action permission | Protected by backend authorization |
| `ticket_public:update` | Product action permission | Protected by backend authorization |
...
MVP should keep ticket information internal unless linked to customer-visible conversation replies.

---

# Future Behavior

Future versions may support customer portal, public ticket status, customer comments, and public ticket references.
