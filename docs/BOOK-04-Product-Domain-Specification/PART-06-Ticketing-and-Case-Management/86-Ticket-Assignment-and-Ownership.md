...
chapter: "86"
title: "Ticket Assignment and Ownership"
version: "1.0.0"
status: "official"
owner: "CLARA Product Architecture Team"
last_updated: "2026-07-07"
classification: "product-domain-specification"
previous: "85-Manual-Ticket-Creation.md"
next: "87-Ticket-Priority-and-Severity.md"
---

# Ticket Assignment and Ownership

> *"Defines ticket ownership, assignee, team ownership, and responsibility behavior."*
...
Tickets without clear ownership are easily forgotten and create poor customer experience.
...
CLARA Ticket Assignment should make the responsible user or team clear and auditable.
...
| `ticket:assign_self` | Product action permission | Protected by backend authorization |
...
MVP must support assigning a ticket to an authorized workspace member.

---

# Future Behavior

Future versions may support team assignment, skills-based routing, load balancing, and automatic escalation.
