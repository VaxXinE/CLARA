...
previous: "82-Ticket-Model.md"
next: "84-Ticket-Creation-from-Conversation.md"
---

# Case Lifecycle

> *"Defines how a ticket/case moves from creation to resolution and closure."*
...
Teams need shared language for what work is new, active, waiting, resolved, or closed.
...
CLARA Case Lifecycle should be simple in MVP and auditable whenever the case state changes.
...
MVP must support open, pending, resolved, and closed or archived states depending on product simplicity.

---

# Future Behavior

Future versions may support custom workflows, approval states, blocked state, escalation state, and reopen policies.
