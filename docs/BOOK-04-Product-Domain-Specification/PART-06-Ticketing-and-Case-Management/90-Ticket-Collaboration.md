...
previous: "89-Ticket-Status-Workflow.md"
next: "91-Customer-Visible-Ticket-Behavior.md"
---

# Ticket Collaboration

> *"Defines internal collaboration behavior inside a ticket."*
...
Tickets often require multiple people to coordinate. Internal discussion must be separate from customer-visible communication.
...
CLARA should support internal collaboration through notes, mentions, and assignment history without exposing internal content to customers by default.
...
|---|---|---|
| `ticket_note:read` | Product action permission | Protected by backend authorization |
| `ticket_note:create` | Product action permission | Protected by backend authorization |
| `ticket_collaborator:update` | Product action permission | Protected by backend authorization |
...
MVP must support internal ticket notes and activity history.

---

# Future Behavior

Future versions may support mentions, watchers, approval requests, private notes, and cross-team collaboration.
