...
previous: "02-Execution-Principles.md"
next: "04-Vertical-Slice-Strategy.md"
project: "CLARA"
---

# MVP Build Strategy

> *"Defines the build strategy for CLARA MVP."*
...
Many MVPs fail because teams build too many incomplete features or build a prototype that cannot safely evolve into production.
...
CLARA MVP should be built as a narrow but production-oriented vertical workflow, not as disconnected modules or throwaway prototype code.
...
A production-minded MVP strategy with included, deferred, and non-negotiable requirements.
...
The MVP should prioritize one complete operational workflow:

```text
Admin creates workspace
Agent manages customer
Customer sends message
Agent replies with AI draft support
Agent creates ticket if needed
Knowledge helps answer
Audit records sensitive actions
Dashboard shows basic status
```
...
- Auth and organization/workspace scope.
- Predefined roles and permissions.
- Customer CRM basics.
- Conversation inbox with one reliable channel.
- Internal knowledge base.
- Human-reviewed AI reply draft.
- Basic ticketing.
- Basic admin controls.
- Basic audit and analytics.
