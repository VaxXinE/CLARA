...
chapter: "113"
title: "Channel Adapter Implementation"
version: "1.0.0"
status: "official"
owner: "CLARA Engineering Team"
last_updated: "2026-07-07"
classification: "engineering-execution-plan"
previous: "112-Outbound-Webhook-Delivery.md"
next: "114-Web-Chat-Channel-Implementation.md"
project: "CLARA"
---

# Channel Adapter Implementation

> *"Defines implementation plan for communication channel adapters that connect external messages to CLARA Conversations and Inbox."*
...
Communication channels are core user workflows; incorrect adapters can lose messages, duplicate messages, or expose internal notes.
...
Channel adapters should normalize external messages into CLARA conversation/message domain objects while preserving provider references and delivery status.
...
Channel adapters connect external communication to CLARA Conversations.

They should map:

```text
external channel account -> CLARA channel connection
external user -> participant/customer candidate
external thread -> conversation
external message -> conversation message
external attachment -> attachment metadata
external delivery state -> delivery event
```

---

# Internal vs Customer-Visible Rule

Channel adapters must never expose internal notes as outbound customer messages.
