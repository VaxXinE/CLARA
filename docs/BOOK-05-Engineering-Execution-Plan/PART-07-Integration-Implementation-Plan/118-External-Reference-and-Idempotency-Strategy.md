...
chapter: "118"
title: "External Reference and Idempotency Strategy"
version: "1.0.0"
status: "official"
owner: "CLARA Engineering Team"
last_updated: "2026-07-07"
classification: "engineering-execution-plan"
previous: "117-WhatsApp-and-Social-Channel-Implementation.md"
next: "119-Integration-Sync-Jobs-and-Backfill.md"
project: "CLARA"
---

# External Reference and Idempotency Strategy

> *"Defines how CLARA stores external provider IDs and prevents duplicate processing."*
...
External providers can retry events or send duplicates; without idempotency CLARA may create duplicate messages, tickets, or actions.
...
Every integration event that can create or mutate data must use provider references and idempotency keys to prevent duplicate side effects.
...
Duplicate events should be safe no-ops, not errors that create retries forever.
