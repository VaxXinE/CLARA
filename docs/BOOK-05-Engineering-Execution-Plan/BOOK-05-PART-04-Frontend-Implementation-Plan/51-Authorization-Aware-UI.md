...
previous: "50-Authenticated-App-Shell.md"
next: "52-Design-System-and-UI-Components.md"
project: "CLARA"
---

# Authorization Aware UI

> *"Defines how frontend should handle roles, permissions, entitlements, disabled states, and protected actions."*
...
UI-only authorization is insecure, but ignoring permissions in UI creates confusing and frustrating user experiences.
...
CLARA frontend should use permission-aware UI for usability while relying on backend authorization as the final enforcement layer.
...
show upgrade/permission message
```
...
Permission-aware UI is for UX only.

Backend must still reject unauthorized requests.

Every protected mutation must be tested on backend.
