...
previous: "166-DevOps-and-Release-Execution-Overview.md"
next: "168-Build-and-Artifact-Strategy.md"
project: "CLARA"
---

# Environment Strategy

> *"Defines CLARA environment strategy for local, test, staging, production, and optional preview environments."*
...
Mixing environments or reusing production secrets in development creates high risk of data leaks and accidental production impact.
...
CLARA should use clearly separated environments with different credentials, databases, provider configs, and deployment gates.
...
|---|---|---|
| local | Developer work | Fake/local data |
| test | Automated checks | Deterministic fake data |
| staging | Release validation | Production-like fake/sanitized data |
| production | Real users | Real protected data |

---

# Critical Rule

Do not use production customer data in local/test environments.
