...
previous: "27-Backend-Architecture-Execution.md"
next: "29-Backend-Module-Boundaries.md"
project: "CLARA"
---

# API Service Structure

> *"Defines folder, module, controller, service, repository, and DTO organization for the backend API service."*
...
Poor folder structure causes mixed responsibilities, hard-to-review code, and inconsistent implementation patterns.
...
CLARA API should organize code by product domain and keep transport, business logic, persistence, and authorization responsibilities separate.
...
# Recommended API Folder Structure
...
|---|---|
| Controller | Transport, request DTO, response DTO |
| Guard/Middleware | Auth, permission, scope |
| Service | Business logic |
| Repository | Scoped persistence access |
| DTO/Schema | Input/output contract |
| Policy | Domain-specific authorization helpers |
| Audit | Sensitive event recording |
