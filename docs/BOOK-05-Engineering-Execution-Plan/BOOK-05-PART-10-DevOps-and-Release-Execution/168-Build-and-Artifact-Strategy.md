...
previous: "167-Environment-Strategy.md"
next: "169-Container-and-Runtime-Strategy.md"
project: "CLARA"
---

# Build and Artifact Strategy

> *"Defines how CLARA builds backend, frontend, workers, packages, and deployable artifacts."*
...
Unreproducible builds make debugging, rollback, and incident response difficult.
...
CLARA builds should be reproducible, versioned, CI-driven, and separated from runtime configuration.
...
environment-agnostic where practical
...
Each deployed service should expose safe version metadata:
