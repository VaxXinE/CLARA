...
chapter: "172"
title: "Secrets and Configuration in Deployment"
version: "1.0.0"
status: "official"
owner: "CLARA Platform Engineering Team"
last_updated: "2026-07-07"
classification: "engineering-execution-plan"
previous: "171-CI-CD-Pipeline-Execution.md"
next: "173-Database-Migration-Release-Execution.md"
project: "CLARA"
---

# Secrets and Configuration in Deployment

> *"Defines how CLARA handles runtime configuration and secrets across environments."*
...
Leaked production secrets can compromise providers, databases, customer data, AI services, and infrastructure.
...
CLARA deployed environments should use environment-specific secrets from secure storage and never bake secrets into images, code, docs, logs, or frontend bundles.
...
not committed
not logged
not available to frontend client unless truly public
not shared with local/test
```
...
Any variable embedded into frontend build should be considered public.
