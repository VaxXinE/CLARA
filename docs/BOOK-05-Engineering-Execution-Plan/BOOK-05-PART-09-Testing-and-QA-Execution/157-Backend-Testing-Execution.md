...
previous: "156-Frontend-Testing-Execution.md"
next: "158-Test-Data-and-Fixtures.md"
project: "CLARA"
---

# Backend Testing Execution

> *"Defines backend testing execution for services, controllers, repositories, authorization, validation, audit, workers, and error handling."*
...
Backend is where security and business rules are enforced; weak backend tests create production risk.
...
CLARA backend tests should prove domain behavior, permission enforcement, scope isolation, validation, audit emission, and safe error responses.
...
# Backend Non-Negotiable Tests

Every protected backend endpoint should have:

```text
unauthenticated test
unauthorized test
wrong org/workspace test
valid actor success test
invalid input test
safe error shape test
```
