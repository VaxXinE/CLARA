...
chapter: "91"
title: "Knowledge Retrieval and RAG Implementation"
version: "1.0.0"
status: "official"
owner: "CLARA Engineering Team"
last_updated: "2026-07-07"
classification: "engineering-execution-plan"
previous: "90-AI-Context-Assembly.md"
next: "92-AI-Reply-Drafting-Implementation.md"
project: "CLARA"
---

# Knowledge Retrieval and RAG Implementation

> *"Defines how CLARA should implement retrieval-augmented generation using eligible Knowledge Base content."*
...
Ungoverned retrieval can ground AI on stale, draft, private, or unauthorized knowledge.
...
CLARA RAG should retrieve only published, permission-scoped, AI-eligible knowledge and preserve source references where practical.
...
```text
1. Receive AI feature request
2. Resolve actor and resource scope
3. Search eligible knowledge
4. Filter by permission/visibility/status
5. Rank/re-rank where practical
6. Build compact grounding context
7. Generate output
8. Return citations/source references where practical
```
...
published
not archived
workspace/organization visible
actor can read
AI eligible
not expired/stale if policy exists
```
...
Do not dump the entire knowledge base into context.
