...
previous: "86-AI-Implementation-Plan-Overview.md"
next: "88-Model-Provider-Abstraction.md"
project: "CLARA"
---

# AI Gateway Architecture

> *"Defines the AI Gateway as the central backend layer for AI requests, provider routing, prompt execution, safety, usage, and logging."*
...
Without an AI Gateway, prompts, provider logic, context assembly, logging, and safety checks become inconsistent and hard to govern.
...
CLARA should route all AI requests through an AI Gateway module rather than allowing direct provider calls from random modules.
...
Product modules should call CLARA AI services, not vendor SDKs directly.
