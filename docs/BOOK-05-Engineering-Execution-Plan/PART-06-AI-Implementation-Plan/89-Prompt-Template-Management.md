...
previous: "88-Model-Provider-Abstraction.md"
next: "90-AI-Context-Assembly.md"
project: "CLARA"
---

# Prompt Template Management

> *"Defines how prompts, system instructions, template variables, brand voice, and prompt versions should be managed."*
...
Unversioned prompts create unpredictable AI behavior and make regressions hard to diagnose.
...
CLARA should treat prompts as versioned product configuration with review, testing, and safe deployment practices.
...
Traceable in audit metadata
```

---

# Prompt Template Example Fields
...
A prompt change can change product behavior.

Treat major prompt updates like code changes:
