...
chapter: "30"
title: "Domain Logic Standards"
version: "1.0.0"
status: "official"
owner: "CLARA Backend Engineering Team"
last_updated: "2026-07-07"
classification: "backend-implementation"
previous: "29-Application-Service-Standards.md"
next: "31-Repository-and-Data-Access-Standards.md"
project: "CLARA"
---

# Domain Logic Standards

> *"Defines standards for domain entities, value objects, business rules, invariants, domain events, and pure logic testing."*
...
Domain behavior becomes hard to reason about when business rules live in database queries or UI logic.
...
CLARA domain logic should be framework-independent, testable, explicit about invariants, and protected from persistence/provider concerns.
...
# Domain Logic Responsibilities

Domain logic should define:
...
ReplyDraftReviewState
IntegrationEventProcessingState
CustomerIdentity
WorkspaceMembership
```
...
Domain rules should be unit-testable without HTTP server, database, queue, or external provider.
