...
chapter: "103"
title: "Migration Deployment Workflow"
version: "1.0.0"
status: "official"
owner: "CLARA Platform Engineering Team"
last_updated: "2026-07-07"
classification: "ci-cd-environment-implementation"
previous: "102-Secret-and-Configuration-Injection.md"
next: "104-Feature-Flag-and-Rollout-Implementation.md"
project: "CLARA"
---

# Migration Deployment Workflow

> *"Defines database migration deployment in CI/CD, compatibility checks, migration ordering, backfill strategy, rollback/forward-fix, and production approval."*
...
A safe application deploy can still become an outage if the database migration is unsafe.
...
CLARA migrations should be deployed through a controlled workflow that validates safety, app compatibility, and production execution evidence.
...
Recommended phased pattern:

```text
1 run pre-deploy compatibility checks
2 deploy backward-compatible schema change
3 deploy app that supports old and new shape
4 run backfill safely if needed
5 validate data
6 enforce constraints
7 remove old code/schema after compatibility window
```
...
Do not couple risky schema changes and application behavior changes into one irreversible production step.
