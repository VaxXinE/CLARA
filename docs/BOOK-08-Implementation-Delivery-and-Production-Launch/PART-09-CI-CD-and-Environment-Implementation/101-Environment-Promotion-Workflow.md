...
previous: "100-Build-and-Artifact-Strategy.md"
next: "102-Secret-and-Configuration-Injection.md"
project: "CLARA"
---

# Environment Promotion Workflow

> *"Defines environment promotion from local/dev to staging and production, approval gates, smoke tests, release evidence, and deployment ownership."*
...
Skipping environment promotion creates production surprises that staging or pre-prod could have caught.
...
CLARA should promote changes through isolated environments using explicit gates and evidence before production release.
...
```text
CI -> development -> staging -> production
```
...
rollback path known
owner available
observability dashboard checked
approval recorded
```
...
Production should receive only artifacts that have passed prior environment validation.
