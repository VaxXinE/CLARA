...
chapter: "93"
title: "Test Data Fixture and Mock Strategy"
version: "1.0.0"
status: "official"
owner: "CLARA Quality Engineering Team"
last_updated: "2026-07-07"
classification: "testing-quality-implementation"
previous: "92-AI-Quality-and-Safety-Testing-Implementation.md"
next: "94-CI-Quality-Gates-and-Coverage-Policy.md"
project: "CLARA"
---

# Test Data Fixture and Mock Strategy

> *"Defines test data, fixtures, mocks, factories, seed datasets, anonymization rules, provider stubs, and deterministic testing strategy."*
...
Bad test data produces false confidence and can create privacy/security issues.
...
CLARA test data should be safe, realistic enough, deterministic, scoped by tenant/workspace, and free from real secrets or customer data.
...
documented
small by default
scoped by workspace/tenant where relevant
free from real secrets
versioned with contract changes
```
...
```text
external providers
AI providers for deterministic tests
payment/billing providers
email/SMS providers
file storage where appropriate
time/clock
random IDs where needed
```

Do not over-mock domain logic that should be tested directly.

---

# Test Data Security Rule

Never use real production customer data, tokens, provider secrets, or private keys in tests or fixtures.
