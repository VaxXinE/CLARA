...
chapter: "45"
title: "Error Loading Empty and Degraded States"
version: "1.0.0"
status: "official"
owner: "CLARA Frontend Engineering Team"
last_updated: "2026-07-07"
classification: "frontend-client-implementation"
previous: "44-Auth-and-Permission-UI-Implementation.md"
next: "46-Frontend-Security-and-Privacy-Baseline.md"
project: "CLARA"
---

# Error Loading Empty and Degraded States

> *"Defines UX standards for loading, error, empty, partial failure, offline, degraded mode, retry, and support escalation states."*
...
A production UI that only handles happy paths feels broken during normal real-world failures.
...
CLARA frontend should intentionally handle non-happy paths so users understand whether the system is loading, empty, blocked, failed, or degraded.
...
```text
AI draft unavailable -> manual reply still works
integration delayed -> show pending status
attachment preview failed -> allow authorized download if possible
analytics unavailable -> show core workflow
search unavailable -> show fallback guidance
```
...
safe
non-speculative
not leaking internal implementation
```
...
A user should never be left wondering whether the app is loading, broken, empty, or forbidden.
