...
chapter: "39"
title: "Routing Layout and Navigation Standards"
version: "1.0.0"
status: "official"
owner: "CLARA Frontend Engineering Team"
last_updated: "2026-07-07"
classification: "frontend-client-implementation"
previous: "38-App-Bootstrap-and-Runtime-Initialization.md"
next: "40-Component-Implementation-Standards.md"
project: "CLARA"
---

# Routing Layout and Navigation Standards

> *"Defines routing, layout, navigation, guarded routes, workspace context, deep links, redirects, and not-found/permission-denied screens."*
...
Routing bugs can expose wrong screens, leak context, or create broken user journeys.
...
CLARA routing should be predictable, permission-aware, workspace-aware, and safe against accidental data exposure across tenants/workspaces.
...
```text
do not show inaccessible navigation items unless intentional
handle expired sessions gracefully
preserve intended destination after login where safe
prevent cross-workspace context confusion
show permission-denied screen for known forbidden access
```
...
Never trust route params alone.

Backend must verify workspace/resource authorization.
