...
chapter: "115"
title: "Residual Risk and Risk Treatment"
version: "1.0.0"
status: "official"
owner: "CLARA Security Governance Team"
last_updated: "2026-07-07"
classification: "risk-register-control-mapping"
previous: "114-Control-Ownership-and-Maturity-Model.md"
next: "116-Risk-Acceptance-Records.md"
project: "CLARA"
---

# Residual Risk and Risk Treatment

> *"Defines how CLARA calculates residual risk and chooses treatment options: mitigate, accept, transfer, avoid, or monitor."*
...
Controls reduce risk but rarely remove it completely; residual risk must be visible.
...
CLARA should explicitly track residual risk after controls and choose a clear treatment decision.
...
- Critical residual risk should not be silently accepted.
- High residual risk requires accountable approval.
- Accepted risk needs review date.
- Mitigation needs owner and due date.
