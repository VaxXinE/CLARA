...
previous: "117-Control-Evidence-Mapping.md"
next: "119-Risk-Review-Cadence-and-Operating-Rhythm.md"
project: "CLARA"
---

# Governance Dashboard and Reporting

> *"Defines the dashboard and reporting model for risks, controls, gaps, exceptions, incidents, vulnerabilities, and review status."*
...
If leadership and owners cannot see risk posture, governance becomes reactive.
...
CLARA governance reporting should make current risk posture, open gaps, overdue reviews, and accepted risks visible.
...
high-risk controls without evidence
...
Dashboard should show reality, not optimism.
