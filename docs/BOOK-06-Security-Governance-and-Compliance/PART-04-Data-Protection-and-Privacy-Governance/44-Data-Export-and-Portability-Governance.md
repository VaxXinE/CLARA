...
chapter: "44"
title: "Data Export and Portability Governance"
version: "1.0.0"
status: "official"
owner: "CLARA Security Governance Team"
last_updated: "2026-07-07"
classification: "data-protection-privacy-governance"
previous: "43-Data-Retention-and-Deletion-Governance.md"
next: "45-Attachment-and-Media-Data-Governance.md"
project: "CLARA"
---

# Data Export and Portability Governance

> *"Defines governance for customer data exports, audit exports, analytics exports, portability requests, admin downloads, and export evidence."*
...
Exports are high-risk because they move protected data outside normal application controls.
...
CLARA exports should be permission-controlled, scoped, logged, time-limited, minimized, and auditable.
...
Exports are high-risk because data leaves normal app controls.
...
audited
rate/size limited
time-limited when file delivery is used
reviewed for sensitive categories
```
...
export type
data scope
row/file count where practical
timestamp
delivery method
