...
EXPECTED_BRANCH="feat/p13-customer-lifecycle-owner-assignment"
...
required_tests=(
  "services/api/tests/p13-customer-lifecycle-status-route.test.ts"
  "services/api/tests/p13-customer-lifecycle-status-service.test.ts"
  "services/api/tests/p13-customer-lifecycle-status-workspace-boundary.test.ts"
  "services/api/tests/p13-customer-owner-assignment-route.test.ts"
  "services/api/tests/p13-customer-owner-assignment-service.test.ts"
  "services/api/tests/p13-customer-owner-assignment-workspace-boundary.test.ts"
  "services/api/tests/p13-customer-owner-assignment-input-validation.test.ts"
  "services/api/tests/p13-customer-lifecycle-owner-activity-timeline.test.ts"
  "services/api/tests/p13-customer-lifecycle-owner-no-billing-side-effect.test.ts"
  "services/api/tests/p13-customer-lifecycle-owner-service.test.ts"
  "services/api/tests/p13-customer-lifecycle-owner-route.test.ts"
  "services/api/tests/db-migration.test.ts"
  "services/api/tests/db-schema.test.ts"
  "apps/dashboard/src/components/p13-customer-lifecycle-owner-assignment.test.tsx"
  "apps/dashboard/src/components/p13-customer-lifecycle-owner-security.test.tsx"
  "apps/dashboard/src/components/CustomerWorkspacePanel.test.tsx"
  "apps/extension/src/tests/p13-customer-lifecycle-owner-extension-boundary.test.ts"
)

for path in "${required_docs[@]}" "${required_tests[@]}"; do
  if [[ ! -f "$ROOT_DIR/$path" ]]; then
    echo "Missing required P13-PR-03 artifact: $path" >&2
    exit 1
  fi
done
...
docs_blob="$(
  cat \
    ...
    "$ROOT_DIR/docs/product/CLARA-P13-CUSTOMER-LIFECYCLE-OWNER-ASSIGNMENT.md" \
...
for phrase in "${required_phrases[@]}"; do
  if ! grep -Fq "$phrase" <<<"$docs_blob"; then
    echo "Missing required P13-PR-03 doc phrase: $phrase" >&2
    exit 1
  fi
done
...
echo "CLARA P13-PR-03 VALIDATION PASSED"
