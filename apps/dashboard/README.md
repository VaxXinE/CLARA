...
required. Demo role switcher is not used in provider mode, and provider mode
does not send mock headers. Backend AuthContext/workspace membership is source
