...
export async function registerCustomerTimelineIntelligenceRoutes(
  app: FastifyInstance,
  authProvider: AuthProvider,
  service: CustomerTimelineIntelligenceService,
): Promise<void> {
  app.get(
    "/api/v1/customers/:customer_id/timeline/intelligence",
    {
    ...
    async (request) => {
      ...
      return service.getCustomerTimelineIntelligence({
        auth,
