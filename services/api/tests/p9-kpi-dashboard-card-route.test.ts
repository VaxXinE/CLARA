...
describe("GET /api/v1/analytics/kpi-dashboard", () => {
  it("requires auth and returns safe aggregate KPI cards", async () => {
    ...
    const authenticated = await app.inject({
      method: "GET",
      url: "/api/v1/analytics/kpi-dashboard?workspaceId=wks_demo_sales&timeWindow=last_7_days",
